 ...
 */
@ApiModel(description = "Details of FrmPaymentMethod are mentioned here... it should be passed in payment connector create api call, and stored in merchant_connector_table")
@JsonPropertyOrder({
...
public class FrmPaymentMethod {
  ...
  **/
  ...
  @ApiModelProperty(value = "payment method types(credit, debit) that can be used in the payment. This field is deprecated. It has not been removed to provide backward compatibility.")
  @JsonIgnore
