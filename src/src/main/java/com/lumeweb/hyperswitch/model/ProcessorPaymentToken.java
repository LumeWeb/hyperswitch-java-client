...
public class ProcessorPaymentToken {
  ...
  /**
   * Return true if this ProcessorPaymentToken object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getProcessorPaymentToken() != null) {
      joiner.add(String.format("%sprocessor_payment_token%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProcessorPaymentToken()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
