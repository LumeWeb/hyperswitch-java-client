 ...
 */
@ApiModel(description = "The response body for retrieving an API Key.")
@JsonPropertyOrder({
...
public class RetrieveApiKeyResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The first few characters of the plaintext API Key to help you identify it.")
