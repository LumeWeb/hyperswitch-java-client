...
public class WalletDataOneOf5 {
  ...
  /**
   * Return true if this WalletData_oneOf_5 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGoPayRedirect() != null) {
      joiner.add(String.format("%sgo_pay_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getGoPayRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
