...
public class PaymentChargeTypeOneOf {
  ...
  /**
   * Return true if this PaymentChargeType_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PaymentChargeTypeOneOf paymentChargeTypeOneOf = (PaymentChargeTypeOneOf) o;
    return Objects.equals(this.stripe, paymentChargeTypeOneOf.stripe);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentChargeTypeOneOf {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getStripe() != null) {
      joiner.add(String.format("%sStripe%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getStripe()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
