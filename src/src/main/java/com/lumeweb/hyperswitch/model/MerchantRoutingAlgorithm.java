...
import com.lumeweb.hyperswitch.model.TransactionType;
...
public class MerchantRoutingAlgorithm {
  ...
  /**
   * Return true if this MerchantRoutingAlgorithm object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAlgorithmFor() != null) {
      joiner.add(String.format("%salgorithm_for%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAlgorithmFor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
