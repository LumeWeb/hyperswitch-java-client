 ...
 */
@ApiModel(description = "Represents a single comparison condition.")
@JsonPropertyOrder({
...
public class Comparison {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The left hand side which will always be a domain input identifier like \"payment.method.cardtype\"")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Additional metadata that the Static Analyzer and Backend does not touch. This can be used to store useful information for the frontend and is required for communication between the static analyzer and the frontend.")
