...
public class MandateAmountData {
  ...
  **/
  ...
  @ApiModelProperty(example = "6540", required = true, value = "The maximum amount to be debited for the mandate transaction")
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-09-10T00:00Z", value = "Specifying start date of the mandate")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-09-10T23:59:59Z", value = "Specifying end date of the mandate")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Additional details required by mandate")
  @JsonIgnore
