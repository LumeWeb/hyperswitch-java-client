...
public class WalletDataOneOf25 {
  ...
  /**
   * Return true if this WalletData_oneOf_25 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCashappQr() != null) {
      joiner.add(String.format("%scashapp_qr%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCashappQr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
