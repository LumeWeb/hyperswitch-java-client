 ...
 */
@ApiModel(description = "Details of FrmPaymentMethodType are mentioned here... it should be passed in payment connector create api call, and stored in merchant_connector_table")
@JsonPropertyOrder({
