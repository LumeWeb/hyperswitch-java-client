...
public class RoutingApiTest {
     ...
     */
    @Test
    public void createARoutingAlgprithmTest() throws ApiException {
        RoutingConfigRequest routingConfigRequest = null;
        RoutingDictionaryRecord response = 
        api.createARoutingAlgprithm(routingConfigRequest);
     ...
     */
    @Test
    public void retrieveARoutingAlgorithmWithItsAlgorithmIdTest() throws ApiException {
        String id = null;
        MerchantRoutingAlgorithm response = 
        api.retrieveARoutingAlgorithmWithItsAlgorithmId(id);
