...
public class MerchantAccountCreate {
  ...
  **/
  ...
  @ApiModelProperty(example = "NewAge Retailer", required = true, value = "Name of the Merchant Account, This will be used as a prefix to generate the id")
  ...
  public MerchantAccountCreate merchantDetails(MerchantAccountCreateMerchantDetails merchantDetails) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Metadata is useful for storing additional, unstructured information about the merchant account.")
  @JsonIgnore
