...
public class FrmMessage {
  ...
  /**
   * Return true if this FrmMessage object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFrmName() != null) {
      joiner.add(String.format("%sfrm_name%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_transaction_id` to the URL query string
    if (getFrmTransactionId() != null) {
      joiner.add(String.format("%sfrm_transaction_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmTransactionId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_transaction_type` to the URL query string
    if (getFrmTransactionType() != null) {
      joiner.add(String.format("%sfrm_transaction_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmTransactionType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_status` to the URL query string
    if (getFrmStatus() != null) {
      joiner.add(String.format("%sfrm_status%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmStatus()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_score` to the URL query string
    if (getFrmScore() != null) {
      joiner.add(String.format("%sfrm_score%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmScore()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_reason` to the URL query string
    if (getFrmReason() != null) {
      joiner.add(String.format("%sfrm_reason%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmReason()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `frm_error` to the URL query string
    if (getFrmError() != null) {
      joiner.add(String.format("%sfrm_error%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFrmError()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
