 ...
 */
public enum PresenceOfCustomerDuringPayment {
  ...
  PresenceOfCustomerDuringPayment(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PresenceOfCustomerDuringPayment fromValue(String value) {
    for (PresenceOfCustomerDuringPayment b : PresenceOfCustomerDuringPayment.values()) {
