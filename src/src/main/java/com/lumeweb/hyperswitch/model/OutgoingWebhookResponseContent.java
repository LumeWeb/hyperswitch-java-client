...
import com.lumeweb.hyperswitch.model.OutgoingWebhookRequestContentHeadersInnerInner;
...
public class OutgoingWebhookResponseContent {
  ...
  /**
   * Return true if this OutgoingWebhookResponseContent object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
      ...
      for (int i = 0; i < getHeaders().size(); i++) {
        if (getHeaders().get(i) != null) {
          joiner.add(String.format("%sheaders%s%s=%s", prefix, suffix,
              ...
              URLEncoder.encode(ApiClient.valueToString(getHeaders().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
      }
    }
    ...
    if (getStatusCode() != null) {
      joiner.add(String.format("%sstatus_code%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getStatusCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
