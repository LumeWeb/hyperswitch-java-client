 ...
 */
@ApiModel(description = "Details of FrmConfigs are mentioned here... it should be passed in payment connector create api call, and stored in merchant_connector_table")
@JsonPropertyOrder({
...
public class FrmConfigs {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "payment methods that can be used in the payment")
