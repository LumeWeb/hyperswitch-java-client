...
/**
 * MerchantConnectorCreateConnectorWalletsDetails
 */
@JsonPropertyOrder({
  MerchantConnectorCreateConnectorWalletsDetails.JSON_PROPERTY_APPLE_PAY_COMBINED,
  MerchantConnectorCreateConnectorWalletsDetails.JSON_PROPERTY_APPLE_PAY,
  MerchantConnectorCreateConnectorWalletsDetails.JSON_PROPERTY_SAMSUNG_PAY,
  MerchantConnectorCreateConnectorWalletsDetails.JSON_PROPERTY_PAZE
})
@JsonTypeName("MerchantConnectorCreate_connector_wallets_details")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MerchantConnectorCreateConnectorWalletsDetails {
  ...
  public MerchantConnectorCreateConnectorWalletsDetails() { 
  }

  public MerchantConnectorCreateConnectorWalletsDetails applePayCombined(Object applePayCombined) {
  ...
  **/
  ...
  @ApiModelProperty(value = "This field contains the Apple Pay certificates and credentials for iOS and Web Apple Pay flow")
  @JsonIgnore
  ...
  public MerchantConnectorCreateConnectorWalletsDetails applePay(Object applePay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field is for our legacy Apple Pay flow that contains the Apple Pay certificates and credentials for only iOS Apple Pay flow")
  @JsonIgnore
  ...
  public MerchantConnectorCreateConnectorWalletsDetails samsungPay(Object samsungPay) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field contains the Samsung Pay certificates and credentials")
  @JsonIgnore
  ...
  public MerchantConnectorCreateConnectorWalletsDetails paze(Object paze) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field contains the Paze certificates and credentials")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    MerchantConnectorCreateConnectorWalletsDetails merchantConnectorCreateConnectorWalletsDetails = (MerchantConnectorCreateConnectorWalletsDetails) o;
    return equalsNullable(this.applePayCombined, merchantConnectorCreateConnectorWalletsDetails.applePayCombined) &&
        equalsNullable(this.applePay, merchantConnectorCreateConnectorWalletsDetails.applePay) &&
        equalsNullable(this.samsungPay, merchantConnectorCreateConnectorWalletsDetails.samsungPay) &&
        equalsNullable(this.paze, merchantConnectorCreateConnectorWalletsDetails.paze);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantConnectorCreateConnectorWalletsDetails {\n");
