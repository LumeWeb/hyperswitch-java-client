...
public class JCSVoucherData {
  ...
  **/
  ...
  @ApiModelProperty(example = "Jane", value = "The billing first name for Japanese convenience stores")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Doe", value = "The billing second name Japanese convenience stores")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example@me.com", value = "The Email ID for Japanese convenience stores")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9123456789", value = "The telephone number for Japanese convenience stores")
  @JsonIgnore
