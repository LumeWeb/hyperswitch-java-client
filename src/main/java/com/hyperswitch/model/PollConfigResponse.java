...
public class PollConfigResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Poll Id")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Interval of the poll")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Frequency of the poll")
