...
public class DisplayAmountOnSdk {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "net amount = amount + order_tax_amount + shipping_cost")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "order tax amount calculated by tax connectors")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "shipping cost for the order")
