...
import com.lumeweb.hyperswitch.model.RefundType;
...
public class RefundsCreateRequest {
  ...
  public RefundsCreateRequest paymentId(@javax.annotation.Nonnull String paymentId) {
  ...
  public RefundsCreateRequest merchantReferenceId(@javax.annotation.Nullable String merchantReferenceId) {
  ...
  public RefundsCreateRequest amount(@javax.annotation.Nullable Long amount) {
  ...
  public RefundsCreateRequest reason(@javax.annotation.Nullable String reason) {
  ...
  public RefundsCreateRequest refundType(@javax.annotation.Nullable RefundType refundType) {
  ...
  public RefundsCreateRequest metadata(@javax.annotation.Nullable Object metadata) {
  ...
  /**
   * Return true if this RefundsCreateRequest object is equal to o.
   */
  @Override
