...
public class NetworkTransactionIdAndCardDetails {
  ...
  /**
   * Return true if this NetworkTransactionIdAndCardDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNetworkTransactionId() != null) {
      joiner.add(String.format("%snetwork_transaction_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getNetworkTransactionId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
