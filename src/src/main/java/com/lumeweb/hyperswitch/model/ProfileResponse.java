...
import com.lumeweb.hyperswitch.model.AuthenticationConnectorDetails;
import com.lumeweb.hyperswitch.model.BusinessPaymentLinkConfig;
import com.lumeweb.hyperswitch.model.BusinessPayoutLinkConfig;
import com.lumeweb.hyperswitch.model.ExtendedCardInfoConfig;
import com.lumeweb.hyperswitch.model.OrderFulfillmentTimeOrigin;
import com.lumeweb.hyperswitch.model.WebhookDetails;
...
public class ProfileResponse {
  ...
  public ProfileResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ProfileResponse collectShippingDetailsFromWalletConnectorIfRequired(@javax.annotation.Nullable Boolean collectShippingDetailsFromWalletConnectorIfRequired) {
  ...
  public ProfileResponse collectBillingDetailsFromWalletConnectorIfRequired(@javax.annotation.Nullable Boolean collectBillingDetailsFromWalletConnectorIfRequired) {
  ...
  public ProfileResponse orderFulfillmentTime(@javax.annotation.Nullable Integer orderFulfillmentTime) {
  ...
  public ProfileResponse orderFulfillmentTimeOrigin(@javax.annotation.Nullable OrderFulfillmentTimeOrigin orderFulfillmentTimeOrigin) {
  ...
  public ProfileResponse shouldCollectCvvDuringPayment(@javax.annotation.Nonnull Boolean shouldCollectCvvDuringPayment) {
  ...
  @JsonProperty(JSON_PROPERTY_SHOULD_COLLECT_CVV_DURING_PAYMENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setShouldCollectCvvDuringPayment(@javax.annotation.Nonnull Boolean shouldCollectCvvDuringPayment) {
    this.shouldCollectCvvDuringPayment = shouldCollectCvvDuringPayment;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getProfileName() != null) {
      joiner.add(String.format("%sprofile_name%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProfileName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getEnablePaymentResponseHash() != null) {
      joiner.add(String.format("%senable_payment_response_hash%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEnablePaymentResponseHash()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_response_hash_key` to the URL query string
    if (getPaymentResponseHashKey() != null) {
      joiner.add(String.format("%spayment_response_hash_key%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentResponseHashKey()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `redirect_to_merchant_with_http_post` to the URL query string
    if (getRedirectToMerchantWithHttpPost() != null) {
      joiner.add(String.format("%sredirect_to_merchant_with_http_post%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRedirectToMerchantWithHttpPost()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getApplepayVerifiedDomains() != null) {
      for (int i = 0; i < getApplepayVerifiedDomains().size(); i++) {
        joiner.add(String.format("%sapplepay_verified_domains%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(ApiClient.valueToString(getApplepayVerifiedDomains().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
    ...
    if (getUseBillingAsPaymentMethodBilling() != null) {
      joiner.add(String.format("%suse_billing_as_payment_method_billing%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUseBillingAsPaymentMethodBilling()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `collect_shipping_details_from_wallet_connector_if_required` to the URL query string
    if (getCollectShippingDetailsFromWalletConnectorIfRequired() != null) {
      joiner.add(String.format("%scollect_shipping_details_from_wallet_connector_if_required%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCollectShippingDetailsFromWalletConnectorIfRequired()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `collect_billing_details_from_wallet_connector_if_required` to the URL query string
    if (getCollectBillingDetailsFromWalletConnectorIfRequired() != null) {
      joiner.add(String.format("%scollect_billing_details_from_wallet_connector_if_required%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCollectBillingDetailsFromWalletConnectorIfRequired()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getAlwaysCollectShippingDetailsFromWalletConnector() != null) {
      joiner.add(String.format("%salways_collect_shipping_details_from_wallet_connector%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAlwaysCollectShippingDetailsFromWalletConnector()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getAlwaysCollectBillingDetailsFromWalletConnector() != null) {
      joiner.add(String.format("%salways_collect_billing_details_from_wallet_connector%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAlwaysCollectBillingDetailsFromWalletConnector()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_connector_agnostic_mit_enabled` to the URL query string
    if (getIsConnectorAgnosticMitEnabled() != null) {
      joiner.add(String.format("%sis_connector_agnostic_mit_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsConnectorAgnosticMitEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getOutgoingWebhookCustomHttpHeaders() != null) {
      joiner.add(String.format("%soutgoing_webhook_custom_http_headers%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOutgoingWebhookCustomHttpHeaders()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `order_fulfillment_time` to the URL query string
    if (getOrderFulfillmentTime() != null) {
      joiner.add(String.format("%sorder_fulfillment_time%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOrderFulfillmentTime()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `order_fulfillment_time_origin` to the URL query string
    if (getOrderFulfillmentTimeOrigin() != null) {
      joiner.add(String.format("%sorder_fulfillment_time_origin%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOrderFulfillmentTimeOrigin()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `tax_connector_id` to the URL query string
    if (getTaxConnectorId() != null) {
      joiner.add(String.format("%stax_connector_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTaxConnectorId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_tax_connector_enabled` to the URL query string
    if (getIsTaxConnectorEnabled() != null) {
      joiner.add(String.format("%sis_tax_connector_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsTaxConnectorEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_network_tokenization_enabled` to the URL query string
    if (getIsNetworkTokenizationEnabled() != null) {
      joiner.add(String.format("%sis_network_tokenization_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsNetworkTokenizationEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `should_collect_cvv_during_payment` to the URL query string
    if (getShouldCollectCvvDuringPayment() != null) {
      joiner.add(String.format("%sshould_collect_cvv_during_payment%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getShouldCollectCvvDuringPayment()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
