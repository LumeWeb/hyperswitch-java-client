 ...
 */
@ApiModel(description = "Masked payout method details for ach bank transfer payout method")
@JsonPropertyOrder({
...
public class AchBankTransferAdditionalData {
  ...
  **/
  ...
  @ApiModelProperty(example = "0001****3456", required = true, value = "Partially masked account number for ach bank debit payment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "110***000", required = true, value = "Partially masked routing number for ach bank debit payment")
