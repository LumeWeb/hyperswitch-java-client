...
import com.lumeweb.hyperswitch.model.DeviceChannel;
import com.lumeweb.hyperswitch.model.SdkInformation;
import com.lumeweb.hyperswitch.model.ThreeDsCompletionIndicator;
...
public class PaymentsExternalAuthenticationRequest {
  ...
  /**
   * Return true if this PaymentsExternalAuthenticationRequest object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDeviceChannel() != null) {
      joiner.add(String.format("%sdevice_channel%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDeviceChannel()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `threeds_method_comp_ind` to the URL query string
    if (getThreedsMethodCompInd() != null) {
      joiner.add(String.format("%sthreeds_method_comp_ind%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getThreedsMethodCompInd()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
