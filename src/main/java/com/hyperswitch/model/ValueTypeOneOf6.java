 ...
 */
@JsonPropertyOrder({
  ValueTypeOneOf6.JSON_PROPERTY_TYPE,
...
public class ValueTypeOneOf6 {
  ...
  **/
  ...
  public ValueTypeOneOf6 addValueItem(NumberComparison valueItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Like a number array but can include comparisons. Useful for conditions like \"500 < amount < 1000\" eg: payment.amount = (> 500, < 1000)")
  ...
  public boolean equals(Object o) {
    ...
    ValueTypeOneOf6 valueTypeOneOf6 = (ValueTypeOneOf6) o;
    return Objects.equals(this.type, valueTypeOneOf6.type) &&
        Objects.equals(this.value, valueTypeOneOf6.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValueTypeOneOf6 {\n");
