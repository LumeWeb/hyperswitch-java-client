...
public class PixBankTransfer {
  ...
  /**
   * Return true if this PixBankTransfer object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBankBranch() != null) {
      joiner.add(String.format("%sbank_branch%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBankBranch()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getTaxId() != null) {
      joiner.add(String.format("%stax_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTaxId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
