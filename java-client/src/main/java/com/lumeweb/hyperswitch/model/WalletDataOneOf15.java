...
public class WalletDataOneOf15 {
  ...
  /**
   * Return true if this WalletData_oneOf_15 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMobilePayRedirect() != null) {
      joiner.add(String.format("%smobile_pay_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMobilePayRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
