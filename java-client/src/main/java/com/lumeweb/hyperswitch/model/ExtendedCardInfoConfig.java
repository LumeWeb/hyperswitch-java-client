...
public class ExtendedCardInfoConfig {
  ...
  /**
   * Return true if this ExtendedCardInfoConfig object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPublicKey() != null) {
      joiner.add(String.format("%spublic_key%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPublicKey()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `ttl_in_secs` to the URL query string
    if (getTtlInSecs() != null) {
      joiner.add(String.format("%sttl_in_secs%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTtlInSecs()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
