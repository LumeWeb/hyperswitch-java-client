...
public class RefundListResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The number of refunds included in the list")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total number of refunds in the list")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The List of refund response object")
