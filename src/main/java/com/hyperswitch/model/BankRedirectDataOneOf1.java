...
public class BankRedirectDataOneOf1 {
  ...
  /**
   * Return true if this BankRedirectData_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BankRedirectDataOneOf1 bankRedirectDataOneOf1 = (BankRedirectDataOneOf1) o;
    return Objects.equals(this.bizum, bankRedirectDataOneOf1.bizum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bizum);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BankRedirectDataOneOf1 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBizum() != null) {
      joiner.add(String.format("%sbizum%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBizum()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
