...
public class WalletDataOneOf24 {
  ...
  /**
   * Return true if this WalletData_oneOf_24 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWeChatPayQr() != null) {
      joiner.add(String.format("%swe_chat_pay_qr%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWeChatPayQr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
