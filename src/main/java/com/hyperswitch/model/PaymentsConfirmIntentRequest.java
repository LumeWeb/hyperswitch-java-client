...
import com.hyperswitch.model.PaymentMethodDataRequest;
 ...
 */
@ApiModel(description = "Request for Payment Intent Confirm")
@JsonPropertyOrder({
...
public class PaymentsConfirmIntentRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://hyperswitch.io", value = "The URL to which you want the user to be redirected after the completion of the payment operation If this url is not passed, the url configured in the business profile will be used")
  @JsonIgnore
  ...
  **/
  ...
  public PaymentsConfirmIntentRequest shipping(CustomerPaymentMethodBilling shipping) {
  ...
  **/
  ...
  public PaymentsConfirmIntentRequest customerAcceptance(MandateDataCustomerAcceptance customerAcceptance) {
  ...
  **/
  ...
  public PaymentsConfirmIntentRequest browserInfo(PaymentsConfirmIntentRequestBrowserInfo browserInfo) {
