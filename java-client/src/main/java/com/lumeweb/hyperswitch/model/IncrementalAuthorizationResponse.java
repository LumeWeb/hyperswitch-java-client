...
import com.lumeweb.hyperswitch.model.AuthorizationStatus;
...
public class IncrementalAuthorizationResponse {
  ...
  /**
   * Return true if this IncrementalAuthorizationResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAuthorizationId() != null) {
      joiner.add(String.format("%sauthorization_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAuthorizationId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPreviouslyAuthorizedAmount() != null) {
      joiner.add(String.format("%spreviously_authorized_amount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPreviouslyAuthorizedAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
