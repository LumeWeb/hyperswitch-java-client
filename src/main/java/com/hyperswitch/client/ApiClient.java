...
import com.hyperswitch.client.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    authentications.put("admin_api_key", new ApiKeyAuth("header", "api-key"));
    authentications.put("api_key", new ApiKeyAuth("header", "api-key"));
    authentications.put("ephemeral_key", new ApiKeyAuth("header", "api-key"));
    authentications.put("publishable_key", new ApiKeyAuth("header", "api-key"));
