...
public class FieldTypeOneOf2 {
  ...
  public FieldTypeOneOf2 userAddressCountry(@javax.annotation.Nonnull FieldTypeOneOfUserCountry userAddressCountry) {
  ...
  /**
   * Return true if this FieldType_oneOf_2 object is equal to o.
   */
  @Override
