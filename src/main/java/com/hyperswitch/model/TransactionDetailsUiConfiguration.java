...
public class TransactionDetailsUiConfiguration {
  ...
  /**
   * Return true if this TransactionDetailsUiConfiguration object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsKeyBold() != null) {
      joiner.add(String.format("%sis_key_bold%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsKeyBold()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_value_bold` to the URL query string
    if (getIsValueBold() != null) {
      joiner.add(String.format("%sis_value_bold%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsValueBold()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
