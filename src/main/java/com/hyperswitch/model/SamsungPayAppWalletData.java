...
public class SamsungPayAppWalletData {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Currency type of the payment")
  ...
  **/
  ...
  @ApiModelProperty(value = "Last 4 digits of the device specific card number")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Merchant reference id that was passed in the session call request")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies authentication method used")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Value if credential is enabled for recurring payment")
  @JsonIgnore
