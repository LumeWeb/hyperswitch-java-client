...
public class WalletDataOneOf12 {
  ...
  /**
   * Return true if this WalletData_oneOf_12 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGooglePayRedirect() != null) {
      joiner.add(String.format("%sgoogle_pay_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getGooglePayRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
