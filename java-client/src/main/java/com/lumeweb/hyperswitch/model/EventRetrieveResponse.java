...
import com.lumeweb.hyperswitch.model.EventClass;
import com.lumeweb.hyperswitch.model.EventType;
import com.lumeweb.hyperswitch.model.OutgoingWebhookRequestContent;
import com.lumeweb.hyperswitch.model.OutgoingWebhookResponseContent;
import com.lumeweb.hyperswitch.model.WebhookDeliveryAttempt;
...
public class EventRetrieveResponse {
  ...
  /**
   * Return true if this EventRetrieveResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEventId() != null) {
      joiner.add(String.format("%sevent_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEventId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getObjectId() != null) {
      joiner.add(String.format("%sobject_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getObjectId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getEventClass() != null) {
      joiner.add(String.format("%sevent_class%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEventClass()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_delivery_successful` to the URL query string
    if (getIsDeliverySuccessful() != null) {
      joiner.add(String.format("%sis_delivery_successful%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsDeliverySuccessful()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `initial_attempt_id` to the URL query string
    if (getInitialAttemptId() != null) {
      joiner.add(String.format("%sinitial_attempt_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getInitialAttemptId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getDeliveryAttempt() != null) {
      joiner.add(String.format("%sdelivery_attempt%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDeliveryAttempt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
