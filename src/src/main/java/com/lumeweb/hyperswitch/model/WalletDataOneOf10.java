...
public class WalletDataOneOf10 {
  ...
  /**
   * Return true if this WalletData_oneOf_10 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDanaRedirect() != null) {
      joiner.add(String.format("%sdana_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDanaRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
