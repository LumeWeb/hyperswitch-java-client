...
import com.hyperswitch.model.BusinessCollectLinkConfigAllOf;
import com.hyperswitch.model.BusinessGenericLinkConfig;
...
public class BusinessCollectLinkConfig {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[{\"payment_method\": \"bank_transfer\", \"payment_method_types\": [\"ach\", \"bacs\", \"sepa\"]}]", required = true, value = "List of payment methods shown on collect UI")
