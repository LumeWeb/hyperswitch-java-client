...
public class OpenBankingDataOneOf {
  ...
  public OpenBankingDataOneOf openBankingPis(@javax.annotation.Nonnull Object openBankingPis) {
  ...
  /**
   * Return true if this OpenBankingData_oneOf object is equal to o.
   */
  @Override
