...
public class NextActionDataOneOf4 {
  ...
  /**
   * Return true if this NextActionData_oneOf_4 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getQrCodeFetchUrl() != null) {
      joiner.add(String.format("%sqr_code_fetch_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getQrCodeFetchUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
