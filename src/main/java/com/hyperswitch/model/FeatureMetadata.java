 ...
 */
@ApiModel(description = "additional data that might be required by hyperswitch")
@JsonPropertyOrder({
...
public class FeatureMetadata {
  ...
  public FeatureMetadata redirectResponse(FeatureMetadataRedirectResponse redirectResponse) {
