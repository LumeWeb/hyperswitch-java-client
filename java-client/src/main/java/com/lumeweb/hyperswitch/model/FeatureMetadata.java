...
import com.lumeweb.hyperswitch.model.RedirectResponse;
...
public class FeatureMetadata {
  ...
  /**
   * Return true if this FeatureMetadata object is equal to o.
   */
  @Override
    ...
    if (getSearchTags() != null) {
      for (int i = 0; i < getSearchTags().size(); i++) {
        joiner.add(String.format("%ssearch_tags%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(ApiClient.valueToString(getSearchTags().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
