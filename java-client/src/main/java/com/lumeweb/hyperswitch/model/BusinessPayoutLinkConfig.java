...
public class BusinessPayoutLinkConfig {
  ...
  /**
   * Return true if this BusinessPayoutLinkConfig object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPayoutTestMode() != null) {
      joiner.add(String.format("%spayout_test_mode%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayoutTestMode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
