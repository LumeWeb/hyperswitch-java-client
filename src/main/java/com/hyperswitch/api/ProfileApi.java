...
public interface ProfileApi extends ApiClient.Api {
  ...
  LinkedRoutingConfigRetrieveResponse retrieveTheActiveRoutingAlgorithmUnderTheProfile(@Param("id") String id, @QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<LinkedRoutingConfigRetrieveResponse> retrieveTheActiveRoutingAlgorithmUnderTheProfileWithHttpInfo(@Param("id") String id, @QueryMap(encoded=true) Map<String, Object> queryParams);
