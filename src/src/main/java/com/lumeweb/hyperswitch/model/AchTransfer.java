...
public class AchTransfer {
  ...
  /**
   * Return true if this AchTransfer object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSwiftCode() != null) {
      joiner.add(String.format("%sswift_code%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSwiftCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
