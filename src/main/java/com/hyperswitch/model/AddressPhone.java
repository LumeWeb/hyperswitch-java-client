...
import com.hyperswitch.model.PhoneDetails;
 ...
 */
@JsonPropertyOrder({
  AddressPhone.JSON_PROPERTY_NUMBER,
  AddressPhone.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("Address_phone")
...
public class AddressPhone {
  ...
  public AddressPhone number(String number) {
  ...
  **/
  ...
  @ApiModelProperty(example = "9123456789", value = "The contact number")
  @JsonIgnore
  ...
  public AddressPhone countryCode(String countryCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "+1", value = "The country code attached to the number")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    AddressPhone addressPhone = (AddressPhone) o;
    return equalsNullable(this.number, addressPhone.number) &&
        equalsNullable(this.countryCode, addressPhone.countryCode);
  }
