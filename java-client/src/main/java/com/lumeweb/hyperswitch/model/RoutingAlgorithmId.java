...
public class RoutingAlgorithmId {
  ...
  public RoutingAlgorithmId routingAlgorithmId(@javax.annotation.Nonnull String routingAlgorithmId) {
  ...
  @JsonProperty(JSON_PROPERTY_ROUTING_ALGORITHM_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRoutingAlgorithmId(@javax.annotation.Nonnull String routingAlgorithmId) {
    this.routingAlgorithmId = routingAlgorithmId;
  }


  /**
   * Return true if this RoutingAlgorithmId object is equal to o.
   */
  @Override
