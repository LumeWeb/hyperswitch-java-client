...
public class WalletDataOneOf {
  ...
  /**
   * Return true if this WalletData_oneOf object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAliPayQr() != null) {
      joiner.add(String.format("%sali_pay_qr%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAliPayQr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
