...
public class AmountDetailsResponse {
  ...
  public AmountDetailsResponse orderAmount(Long orderAmount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "6540", required = true, value = "The payment amount. Amount for the payment in the lowest denomination of the currency, (i.e) in cents for USD denomination, in yen for JPY denomination etc. E.g., Pass 100 to charge $1.00 and 1 for 1¥ since ¥ is a zero-decimal currency. Read more about [the Decimal and Non-Decimal Currencies](https://github.com/juspay/hyperswitch/wiki/Decimal-and-Non%E2%80%90Decimal-Currencies)")
  ...
  public AmountDetailsResponse currency(Currency currency) {
  ...
  **/
  ...
  public AmountDetailsResponse shippingCost(Long shippingCost) {
  ...
  **/
  ...
  public AmountDetailsResponse orderTaxAmount(Long orderTaxAmount) {
  ...
  **/
  ...
  public AmountDetailsResponse skipExternalTaxCalculation(TaxCalculationOverride skipExternalTaxCalculation) {
  ...
  **/
  ...
  public AmountDetailsResponse skipSurchargeCalculation(SurchargeCalculationOverride skipSurchargeCalculation) {
  ...
  **/
  ...
  public AmountDetailsResponse surchargeAmount(Long surchargeAmount) {
  ...
  **/
  ...
  public AmountDetailsResponse taxOnSurcharge(Long taxOnSurcharge) {
