...
public class GsmDeleteResponse {
  ...
  /**
   * Return true if this GsmDeleteResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGsmRuleDelete() != null) {
      joiner.add(String.format("%sgsm_rule_delete%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getGsmRuleDelete()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
