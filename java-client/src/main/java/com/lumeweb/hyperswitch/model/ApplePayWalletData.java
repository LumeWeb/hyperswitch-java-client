...
import com.lumeweb.hyperswitch.model.ApplepayPaymentMethod;
...
public class ApplePayWalletData {
  ...
  /**
   * Return true if this ApplePayWalletData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPaymentData() != null) {
      joiner.add(String.format("%spayment_data%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentData()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getTransactionIdentifier() != null) {
      joiner.add(String.format("%stransaction_identifier%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTransactionIdentifier()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
