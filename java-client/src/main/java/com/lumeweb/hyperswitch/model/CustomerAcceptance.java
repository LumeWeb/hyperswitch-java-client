...
import com.lumeweb.hyperswitch.model.AcceptanceType;
import com.lumeweb.hyperswitch.model.OnlineMandate;
...
public class CustomerAcceptance {
  ...
  /**
   * Return true if this CustomerAcceptance object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAcceptanceType() != null) {
      joiner.add(String.format("%sacceptance_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAcceptanceType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `accepted_at` to the URL query string
    if (getAcceptedAt() != null) {
      joiner.add(String.format("%saccepted_at%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAcceptedAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
