...
public class GsmResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "status provided by the router")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "decision to be taken for auto retries flow")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "indicates if step_up retry is possible")
