...
*/
    @JsonPropertyOrder({
        PaymentsUpdateRequest.JSON_PROPERTY_AMOUNT,
        PaymentsUpdateRequest.JSON_PROPERTY_CURRENCY,
        PaymentsUpdateRequest.JSON_PROPERTY_AMOUNT_TO_CAPTURE,
        PaymentsUpdateRequest.JSON_PROPERTY_SHIPPING_COST,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_ID,
        PaymentsUpdateRequest.JSON_PROPERTY_ROUTING,
        PaymentsUpdateRequest.JSON_PROPERTY_CONNECTOR,
        PaymentsUpdateRequest.JSON_PROPERTY_CAPTURE_METHOD,
        PaymentsUpdateRequest.JSON_PROPERTY_AUTHENTICATION_TYPE,
        PaymentsUpdateRequest.JSON_PROPERTY_BILLING,
        PaymentsUpdateRequest.JSON_PROPERTY_CONFIRM,
        PaymentsUpdateRequest.JSON_PROPERTY_CUSTOMER,
        PaymentsUpdateRequest.JSON_PROPERTY_CUSTOMER_ID,
        PaymentsUpdateRequest.JSON_PROPERTY_OFF_SESSION,
        PaymentsUpdateRequest.JSON_PROPERTY_DESCRIPTION,
        PaymentsUpdateRequest.JSON_PROPERTY_RETURN_URL,
        PaymentsUpdateRequest.JSON_PROPERTY_SETUP_FUTURE_USAGE,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_METHOD_DATA,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_METHOD,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_TOKEN,
        PaymentsUpdateRequest.JSON_PROPERTY_SHIPPING,
        PaymentsUpdateRequest.JSON_PROPERTY_STATEMENT_DESCRIPTOR_NAME,
        PaymentsUpdateRequest.JSON_PROPERTY_STATEMENT_DESCRIPTOR_SUFFIX,
        PaymentsUpdateRequest.JSON_PROPERTY_ORDER_DETAILS,
        PaymentsUpdateRequest.JSON_PROPERTY_MANDATE_DATA,
        PaymentsUpdateRequest.JSON_PROPERTY_CUSTOMER_ACCEPTANCE,
        PaymentsUpdateRequest.JSON_PROPERTY_BROWSER_INFO,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_EXPERIENCE,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_METHOD_TYPE,
        PaymentsUpdateRequest.JSON_PROPERTY_MERCHANT_CONNECTOR_DETAILS,
        PaymentsUpdateRequest.JSON_PROPERTY_ALLOWED_PAYMENT_METHOD_TYPES,
        PaymentsUpdateRequest.JSON_PROPERTY_RETRY_ACTION,
        PaymentsUpdateRequest.JSON_PROPERTY_METADATA,
        PaymentsUpdateRequest.JSON_PROPERTY_CONNECTOR_METADATA,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_LINK,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_LINK_CONFIG,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_LINK_CONFIG_ID,
        PaymentsUpdateRequest.JSON_PROPERTY_SURCHARGE_DETAILS,
        PaymentsUpdateRequest.JSON_PROPERTY_PAYMENT_TYPE,
        PaymentsUpdateRequest.JSON_PROPERTY_REQUEST_INCREMENTAL_AUTHORIZATION,
        PaymentsUpdateRequest.JSON_PROPERTY_SESSION_EXPIRY,
        PaymentsUpdateRequest.JSON_PROPERTY_FRM_METADATA,
        PaymentsUpdateRequest.JSON_PROPERTY_REQUEST_EXTERNAL_THREE_DS_AUTHENTICATION,
        PaymentsUpdateRequest.JSON_PROPERTY_RECURRING_DETAILS,
        PaymentsUpdateRequest.JSON_PROPERTY_CHARGES,
        PaymentsUpdateRequest.JSON_PROPERTY_MERCHANT_ORDER_REFERENCE_ID,
...
public PaymentsUpdateRequest() {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        return this;
            ...
            public PaymentsUpdateRequest addConnectorItem(Connector connectorItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        return this;
            ...
            public PaymentsUpdateRequest addOrderDetailsItem(OrderDetailsWithAmount orderDetailsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        return this;
            ...
            public PaymentsUpdateRequest addAllowedPaymentMethodTypesItem(PaymentMethodType allowedPaymentMethodTypesItem) {
...
public boolean equals(Object o) {
    ...
    return false;
        ...
        PaymentsUpdateRequest paymentsUpdateRequest = (PaymentsUpdateRequest) o;
        return equalsNullable(this.amount, paymentsUpdateRequest.amount) &&
        equalsNullable(this.currency, paymentsUpdateRequest.currency) &&
        equalsNullable(this.amountToCapture, paymentsUpdateRequest.amountToCapture) &&
        equalsNullable(this.shippingCost, paymentsUpdateRequest.shippingCost) &&
        equalsNullable(this.paymentId, paymentsUpdateRequest.paymentId) &&
        equalsNullable(this.routing, paymentsUpdateRequest.routing) &&
        equalsNullable(this.connector, paymentsUpdateRequest.connector) &&
        equalsNullable(this.captureMethod, paymentsUpdateRequest.captureMethod) &&
        equalsNullable(this.authenticationType, paymentsUpdateRequest.authenticationType) &&
        equalsNullable(this.billing, paymentsUpdateRequest.billing) &&
        equalsNullable(this.confirm, paymentsUpdateRequest.confirm) &&
        equalsNullable(this.customer, paymentsUpdateRequest.customer) &&
        equalsNullable(this.customerId, paymentsUpdateRequest.customerId) &&
        equalsNullable(this.offSession, paymentsUpdateRequest.offSession) &&
        equalsNullable(this.description, paymentsUpdateRequest.description) &&
        equalsNullable(this.returnUrl, paymentsUpdateRequest.returnUrl) &&
        equalsNullable(this.setupFutureUsage, paymentsUpdateRequest.setupFutureUsage) &&
        equalsNullable(this.paymentMethodData, paymentsUpdateRequest.paymentMethodData) &&
        equalsNullable(this.paymentMethod, paymentsUpdateRequest.paymentMethod) &&
        equalsNullable(this.paymentToken, paymentsUpdateRequest.paymentToken) &&
        equalsNullable(this.shipping, paymentsUpdateRequest.shipping) &&
        equalsNullable(this.statementDescriptorName, paymentsUpdateRequest.statementDescriptorName) &&
        equalsNullable(this.statementDescriptorSuffix, paymentsUpdateRequest.statementDescriptorSuffix) &&
        equalsNullable(this.orderDetails, paymentsUpdateRequest.orderDetails) &&
        equalsNullable(this.mandateData, paymentsUpdateRequest.mandateData) &&
        equalsNullable(this.customerAcceptance, paymentsUpdateRequest.customerAcceptance) &&
        equalsNullable(this.browserInfo, paymentsUpdateRequest.browserInfo) &&
        equalsNullable(this.paymentExperience, paymentsUpdateRequest.paymentExperience) &&
        equalsNullable(this.paymentMethodType, paymentsUpdateRequest.paymentMethodType) &&
        equalsNullable(this.merchantConnectorDetails, paymentsUpdateRequest.merchantConnectorDetails) &&
        equalsNullable(this.allowedPaymentMethodTypes, paymentsUpdateRequest.allowedPaymentMethodTypes) &&
        equalsNullable(this.retryAction, paymentsUpdateRequest.retryAction) &&
        equalsNullable(this.metadata, paymentsUpdateRequest.metadata) &&
        equalsNullable(this.connectorMetadata, paymentsUpdateRequest.connectorMetadata) &&
        equalsNullable(this.paymentLink, paymentsUpdateRequest.paymentLink) &&
        equalsNullable(this.paymentLinkConfig, paymentsUpdateRequest.paymentLinkConfig) &&
        equalsNullable(this.paymentLinkConfigId, paymentsUpdateRequest.paymentLinkConfigId) &&
        equalsNullable(this.surchargeDetails, paymentsUpdateRequest.surchargeDetails) &&
        equalsNullable(this.paymentType, paymentsUpdateRequest.paymentType) &&
        equalsNullable(this.requestIncrementalAuthorization, paymentsUpdateRequest.requestIncrementalAuthorization) &&
        equalsNullable(this.sessionExpiry, paymentsUpdateRequest.sessionExpiry) &&
        equalsNullable(this.frmMetadata, paymentsUpdateRequest.frmMetadata) &&
        equalsNullable(this.requestExternalThreeDsAuthentication, paymentsUpdateRequest.requestExternalThreeDsAuthentication) &&
        equalsNullable(this.recurringDetails, paymentsUpdateRequest.recurringDetails) &&
        equalsNullable(this.charges, paymentsUpdateRequest.charges) &&
        equalsNullable(this.merchantOrderReferenceId, paymentsUpdateRequest.merchantOrderReferenceId) &&
        equalsNullable(this.skipExternalTaxCalculation, paymentsUpdateRequest.skipExternalTaxCalculation) &&
        equalsNullable(this.psd2ScaExemptionType, paymentsUpdateRequest.psd2ScaExemptionType);
}
    ...
    sb.append("class PaymentsUpdateRequest {\n");
