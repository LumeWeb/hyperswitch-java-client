 ...
 */
@ApiModel(description = "Masked payout method details for paypal wallet payout method")
@JsonPropertyOrder({
...
public class PaypalAdditionalData {
  ...
  public PaypalAdditionalData email(String email) {
  ...
  **/
  ...
  @ApiModelProperty(example = "john.doe@example.com", value = "Email linked with paypal account")
  @JsonIgnore
  ...
  public PaypalAdditionalData telephoneNumber(String telephoneNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "******* 3349", value = "mobile number linked to paypal account")
  @JsonIgnore
  ...
  public PaypalAdditionalData paypalId(String paypalId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "G83K ***** HCQ2", value = "id of the paypal account")
  @JsonIgnore
