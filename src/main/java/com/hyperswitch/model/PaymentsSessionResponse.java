...
public class PaymentsSessionResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "This is a token which expires after 15 minutes, used from the client to authenticate and create sessions from the SDK")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The list of session token object")
