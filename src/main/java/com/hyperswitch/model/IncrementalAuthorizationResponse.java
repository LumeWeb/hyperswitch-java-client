...
public class IncrementalAuthorizationResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The unique identifier of authorization")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6540", required = true, value = "Amount the authorization has been made for")
  ...
  **/
  ...
  @ApiModelProperty(value = "Error code sent by the connector for authorization")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Error message sent by the connector for authorization")
  @JsonIgnore
