...
public class BankDebitDataOneOf2BecsBankDebit {
  ...
  /**
   * Return true if this BankDebitData_oneOf_2_becs_bank_debit object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBsbNumber() != null) {
      joiner.add(String.format("%sbsb_number%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBsbNumber()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
