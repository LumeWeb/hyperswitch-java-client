...
import com.hyperswitch.model.ApplepaySessionTokenResponsePaymentRequestData;
import com.hyperswitch.model.ApplepaySessionTokenResponseSessionTokenData;
...
public class ApplepaySessionTokenResponse {
  ...
  private JsonNullable<ApplepaySessionTokenResponseSessionTokenData> sessionTokenData = JsonNullable.<ApplepaySessionTokenResponseSessionTokenData>undefined();

  public static final String JSON_PROPERTY_PAYMENT_REQUEST_DATA = "payment_request_data";
  private JsonNullable<ApplepaySessionTokenResponsePaymentRequestData> paymentRequestData = JsonNullable.<ApplepaySessionTokenResponsePaymentRequestData>undefined();
  ...
  public ApplepaySessionTokenResponse sessionTokenData(ApplepaySessionTokenResponseSessionTokenData sessionTokenData) {
    this.sessionTokenData = JsonNullable.<ApplepaySessionTokenResponseSessionTokenData>of(sessionTokenData);
  ...
  **/
  ...
  public ApplepaySessionTokenResponseSessionTokenData getSessionTokenData() {
  ...
  public JsonNullable<ApplepaySessionTokenResponseSessionTokenData> getSessionTokenData_JsonNullable() {
    return sessionTokenData;
  }
  
  @JsonProperty(JSON_PROPERTY_SESSION_TOKEN_DATA)
  public void setSessionTokenData_JsonNullable(JsonNullable<ApplepaySessionTokenResponseSessionTokenData> sessionTokenData) {
    this.sessionTokenData = sessionTokenData;
  }

  public void setSessionTokenData(ApplepaySessionTokenResponseSessionTokenData sessionTokenData) {
    this.sessionTokenData = JsonNullable.<ApplepaySessionTokenResponseSessionTokenData>of(sessionTokenData);
  }


  public ApplepaySessionTokenResponse paymentRequestData(ApplepaySessionTokenResponsePaymentRequestData paymentRequestData) {
    this.paymentRequestData = JsonNullable.<ApplepaySessionTokenResponsePaymentRequestData>of(paymentRequestData);
  ...
  **/
  ...
  public ApplepaySessionTokenResponsePaymentRequestData getPaymentRequestData() {
  ...
  public JsonNullable<ApplepaySessionTokenResponsePaymentRequestData> getPaymentRequestData_JsonNullable() {
    return paymentRequestData;
  }
  
  @JsonProperty(JSON_PROPERTY_PAYMENT_REQUEST_DATA)
  public void setPaymentRequestData_JsonNullable(JsonNullable<ApplepaySessionTokenResponsePaymentRequestData> paymentRequestData) {
    this.paymentRequestData = paymentRequestData;
  }

  public void setPaymentRequestData(ApplepaySessionTokenResponsePaymentRequestData paymentRequestData) {
    this.paymentRequestData = JsonNullable.<ApplepaySessionTokenResponsePaymentRequestData>of(paymentRequestData);
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The session token is w.r.t this connector")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The connector transaction id")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The public key id is to invoke third party sdk")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The connector merchant id")
  @JsonIgnore
