...
public class CryptoResponse {
  ...
  public CryptoResponse payCurrency(@javax.annotation.Nullable String payCurrency) {
  ...
  public CryptoResponse network(@javax.annotation.Nullable String network) {
  ...
  /**
   * Return true if this CryptoResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPayCurrency() != null) {
      joiner.add(String.format("%spay_currency%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayCurrency()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
