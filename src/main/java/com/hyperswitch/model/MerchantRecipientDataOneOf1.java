...
public class MerchantRecipientDataOneOf1 {
  ...
  /**
   * Return true if this MerchantRecipientData_oneOf_1 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWalletId() != null) {
      joiner.add(String.format("%swallet_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWalletId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
