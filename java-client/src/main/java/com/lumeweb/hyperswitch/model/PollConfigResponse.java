...
public class PollConfigResponse {
  ...
  /**
   * Return true if this PollConfigResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDelayInSecs() != null) {
      joiner.add(String.format("%sdelay_in_secs%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDelayInSecs()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
