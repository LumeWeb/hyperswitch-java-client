...
public class OpenBankingSessionToken {
  ...
  /**
   * Return true if this OpenBankingSessionToken object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OpenBankingSessionToken openBankingSessionToken = (OpenBankingSessionToken) o;
    return Objects.equals(this.openBankingSessionToken, openBankingSessionToken.openBankingSessionToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(openBankingSessionToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenBankingSessionToken {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOpenBankingSessionToken() != null) {
      joiner.add(String.format("%sopen_banking_session_token%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOpenBankingSessionToken()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
