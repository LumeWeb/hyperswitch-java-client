...
public class OrganizationResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOrganizationDetails() != null) {
      joiner.add(String.format("%sorganization_details%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOrganizationDetails()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
