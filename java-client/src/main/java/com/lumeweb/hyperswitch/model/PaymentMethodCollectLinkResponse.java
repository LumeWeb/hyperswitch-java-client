...
public class PaymentMethodCollectLinkResponse {
  ...
  /**
   * Return true if this PaymentMethodCollectLinkResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPmCollectLinkId() != null) {
      joiner.add(String.format("%spm_collect_link_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPmCollectLinkId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
