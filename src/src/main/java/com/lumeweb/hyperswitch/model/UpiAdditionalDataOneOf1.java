...
public class UpiAdditionalDataOneOf1 {
  ...
  /**
   * Return true if this UpiAdditionalData_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpiAdditionalDataOneOf1 upiAdditionalDataOneOf1 = (UpiAdditionalDataOneOf1) o;
    return Objects.equals(this.upiIntent, upiAdditionalDataOneOf1.upiIntent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(upiIntent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpiAdditionalDataOneOf1 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUpiIntent() != null) {
      joiner.add(String.format("%supi_intent%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUpiIntent()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
