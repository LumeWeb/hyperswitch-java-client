...
public class PayoutListResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The number of payouts included in the list")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The list of payouts response objects")
  ...
  **/
  ...
  @ApiModelProperty(value = "The total number of available payouts for given constraints")
  @JsonIgnore
