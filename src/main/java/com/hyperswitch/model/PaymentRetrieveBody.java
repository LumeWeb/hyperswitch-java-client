...
public class PaymentRetrieveBody {
  ...
  **/
  ...
  @ApiModelProperty(value = "The identifier for the Merchant Account.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Decider to enable or disable the connector call for retrieve request")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is a token which expires after 15 minutes, used from the client to authenticate and create sessions from the SDK")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If enabled provides list of captures linked to latest attempt")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If enabled provides list of attempts linked to payment intent")
  @JsonIgnore
