...
public class NextActionDataOneOf6 {
  ...
  /**
   * Return true if this NextActionData_oneOf_6 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDisplayFromTimestamp() != null) {
      joiner.add(String.format("%sdisplay_from_timestamp%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplayFromTimestamp()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
