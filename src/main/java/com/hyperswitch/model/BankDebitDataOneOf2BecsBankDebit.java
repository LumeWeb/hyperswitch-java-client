...
public class BankDebitDataOneOf2BecsBankDebit {
  ...
  **/
  ...
  @ApiModelProperty(example = "000123456", required = true, value = "Account number for Becs payment method")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "000000", required = true, value = "Bank-State-Branch (bsb) number")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A. Schneider", value = "Owner name for bank debit")
  @JsonIgnore
