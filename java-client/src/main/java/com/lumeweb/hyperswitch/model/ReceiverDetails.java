...
public class ReceiverDetails {
  ...
  /**
   * Return true if this ReceiverDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAmountCharged() != null) {
      joiner.add(String.format("%samount_charged%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAmountCharged()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `amount_remaining` to the URL query string
    if (getAmountRemaining() != null) {
      joiner.add(String.format("%samount_remaining%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAmountRemaining()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
