...
public class BacsBankTransferAdditionalData {
  ...
  /**
   * Return true if this BacsBankTransferAdditionalData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBankSortCode() != null) {
      joiner.add(String.format("%sbank_sort_code%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBankSortCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
