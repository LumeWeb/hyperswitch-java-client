...
public class PayLaterDataOneOf2 {
  ...
  /**
   * Return true if this PayLaterData_oneOf_2 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PayLaterDataOneOf2 payLaterDataOneOf2 = (PayLaterDataOneOf2) o;
    return Objects.equals(this.affirmRedirect, payLaterDataOneOf2.affirmRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(affirmRedirect);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayLaterDataOneOf2 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAffirmRedirect() != null) {
      joiner.add(String.format("%saffirm_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAffirmRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
