...
public class NextActionData {
  ...
  public NextActionData redirectToUrl(@javax.annotation.Nonnull String redirectToUrl) {
  ...
  public NextActionData type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public NextActionData bankTransferStepsAndChargesDetails(@javax.annotation.Nonnull BankTransferNextStepsData bankTransferStepsAndChargesDetails) {
  ...
  public NextActionData sessionToken(@javax.annotation.Nullable SessionToken sessionToken) {
  ...
  public NextActionData imageDataUrl(@javax.annotation.Nonnull String imageDataUrl) {
  ...
  public NextActionData displayToTimestamp(@javax.annotation.Nullable Integer displayToTimestamp) {
  ...
  public NextActionData qrCodeUrl(@javax.annotation.Nonnull String qrCodeUrl) {
  ...
  public NextActionData qrCodeFetchUrl(@javax.annotation.Nonnull String qrCodeFetchUrl) {
  ...
  public NextActionData voucherDetails(@javax.annotation.Nonnull String voucherDetails) {
  ...
  public NextActionData displayFromTimestamp(@javax.annotation.Nonnull Integer displayFromTimestamp) {
  ...
  public NextActionData threeDsData(@javax.annotation.Nonnull ThreeDsData threeDsData) {
  ...
  public NextActionData nextActionData(@javax.annotation.Nonnull SdkNextActionData nextActionData) {
  ...
  public NextActionData consentDataRequired(@javax.annotation.Nonnull MobilePaymentConsent consentDataRequired) {
