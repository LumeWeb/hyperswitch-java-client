...
public class PaymentsDynamicTaxCalculationRequest {
  ...
  /**
   * Return true if this PaymentsDynamicTaxCalculationRequest object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSessionId() != null) {
      joiner.add(String.format("%ssession_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSessionId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
