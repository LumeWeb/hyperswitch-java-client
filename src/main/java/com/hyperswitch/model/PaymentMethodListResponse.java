...
public class PaymentMethodListResponse {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://www.google.com", value = "Redirect URL of the merchant")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[{\"payment_experience\":null,\"payment_method\":\"wallet\",\"payment_method_issuers\":[\"labore magna ipsum\",\"aute\"]}]", required = true, value = "Information about the payment method")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "flag to indicate if surcharge and tax breakup screen should be shown or not")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "flag to indicate whether to perform external 3ds authentication")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "flag that indicates whether to collect shipping details from wallets or from the customer")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "flag that indicates whether to collect billing details from wallets or from the customer")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "flag that indicates whether to calculate tax on the order amount")
