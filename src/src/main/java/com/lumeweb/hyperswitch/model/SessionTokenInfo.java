...
import com.lumeweb.hyperswitch.model.ApplepayInitiative;
...
public class SessionTokenInfo {
  ...
  /**
   * Return true if this SessionTokenInfo object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPaymentProcessingCertificate() != null) {
      joiner.add(String.format("%spayment_processing_certificate%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentProcessingCertificate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_processing_certificate_key` to the URL query string
    if (getPaymentProcessingCertificateKey() != null) {
      joiner.add(String.format("%spayment_processing_certificate_key%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentProcessingCertificateKey()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCertificate() != null) {
      joiner.add(String.format("%scertificate%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCertificate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `certificate_keys` to the URL query string
    if (getCertificateKeys() != null) {
      joiner.add(String.format("%scertificate_keys%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCertificateKeys()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getInitiative() != null) {
      joiner.add(String.format("%sinitiative%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getInitiative()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `initiative_context` to the URL query string
    if (getInitiativeContext() != null) {
      joiner.add(String.format("%sinitiative_context%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getInitiativeContext()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `merchant_business_country` to the URL query string
    if (getMerchantBusinessCountry() != null) {
      joiner.add(String.format("%smerchant_business_country%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMerchantBusinessCountry()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
...
static {
  ...
  mappings.put("SessionTokenInfo", SessionTokenInfo.class);
  JSON.registerDiscriminator(SessionTokenInfo.class, "payment_processing_details_at", mappings);
}
}
