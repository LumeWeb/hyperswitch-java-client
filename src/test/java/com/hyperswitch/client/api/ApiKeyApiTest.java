...
class ApiKeyApiTest {
    ...
    void createAnAPIKeyTest() {
        ...
        // CreateApiKeyResponse response = api.createAnAPIKey(merchantId, createApiKeyRequest);
    ...
    void listAllAPIKeysAssociatedWithAMerchantAccountTest() {
        ...
        Long limit = null;
        Long skip = null;
        // List<RetrieveApiKeyResponse> response = api.listAllAPIKeysAssociatedWithAMerchantAccount(merchantId, limit, skip);
    ...
    void listAllAPIKeysAssociatedWithAMerchantAccountTestQueryMap() {
        ...
        ApiKeyApi.ListAllAPIKeysAssociatedWithAMerchantAccountQueryParams queryParams = new ApiKeyApi.ListAllAPIKeysAssociatedWithAMerchantAccountQueryParams()
            .limit(null)
            .skip(null);
        // List<RetrieveApiKeyResponse> response = api.listAllAPIKeysAssociatedWithAMerchantAccount(merchantId, queryParams);
    ...
    void retrieveAnAPIKeyTest() {
        String merchantId = null;
        String keyId = null;
        // RetrieveApiKeyResponse response = api.retrieveAnAPIKey(merchantId, keyId);
    ...
    void revokeAnAPIKeyTest() {
        String merchantId = null;
        String keyId = null;
        // RevokeApiKeyResponse response = api.revokeAnAPIKey(merchantId, keyId);
    ...
    void updateAnAPIKeyTest() {
        ...
        // RetrieveApiKeyResponse response = api.updateAnAPIKey(merchantId, keyId, updateApiKeyRequest);
