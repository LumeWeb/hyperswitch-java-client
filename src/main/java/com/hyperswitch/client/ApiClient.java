...
import com.hyperswitch.client.auth.HttpBasicAuth;
import com.hyperswitch.client.auth.HttpBearerAuth;
import com.hyperswitch.client.auth.ApiKeyAuth;
import com.hyperswitch.client.ApiResponseDecoder;
...
public class ApiClient {
  ...
  private String basePath = "https://sandbox.hyperswitch.io";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("admin_api_key".equals(authName)) {
        ...
        auth = new ApiKeyAuth("header", "api-key");
      } else if ("publishable_key".equals(authName)) {
        auth = new ApiKeyAuth("header", "api-key");
      } else {
