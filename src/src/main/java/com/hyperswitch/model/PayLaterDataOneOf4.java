...
public class PayLaterDataOneOf4 {
  ...
  /**
   * Return true if this PayLaterData_oneOf_4 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPayBrightRedirect() != null) {
      joiner.add(String.format("%spay_bright_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayBrightRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
