...
import com.hyperswitch.model.ProfileResponseExtendedCardInfoConfig;
...
public class ProfileResponse {
  ...
  private JsonNullable<ProfileResponseExtendedCardInfoConfig> extendedCardInfoConfig = JsonNullable.<ProfileResponseExtendedCardInfoConfig>undefined();
  ...
  **/
  ...
  @ApiModelProperty(example = "y3oqhf46pyzuxjbcn2giaqnb44", required = true, value = "The identifier for Merchant Account")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "pro_abcdefghijklmnopqrstuvwxyz", required = true, value = "The identifier for profile. This must be used for creating merchant accounts, payments and payouts")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Name of the profile")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "A boolean value to indicate if payment response hash needs to be enabled")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "A boolean value to indicate if redirect to merchant with http post needs to be enabled")
  ...
  public ProfileResponse webhookDetails(ProfileCreateWebhookDetails webhookDetails) {
  ...
  **/
  ...
  public ProfileResponse paymentLinkConfig(ProfileCreatePaymentLinkConfig paymentLinkConfig) {
  ...
  **/
  ...
  public ProfileResponse authenticationConnectorDetails(ProfileCreateAuthenticationConnectorDetails authenticationConnectorDetails) {
  ...
  **/
  ...
  public ProfileResponse extendedCardInfoConfig(ProfileResponseExtendedCardInfoConfig extendedCardInfoConfig) {
    this.extendedCardInfoConfig = JsonNullable.<ProfileResponseExtendedCardInfoConfig>of(extendedCardInfoConfig);
  ...
  **/
  ...
  public ProfileResponseExtendedCardInfoConfig getExtendedCardInfoConfig() {
  ...
  public JsonNullable<ProfileResponseExtendedCardInfoConfig> getExtendedCardInfoConfig_JsonNullable() {
    return extendedCardInfoConfig;
  }
  
  @JsonProperty(JSON_PROPERTY_EXTENDED_CARD_INFO_CONFIG)
  public void setExtendedCardInfoConfig_JsonNullable(JsonNullable<ProfileResponseExtendedCardInfoConfig> extendedCardInfoConfig) {
    this.extendedCardInfoConfig = extendedCardInfoConfig;
  }

  public void setExtendedCardInfoConfig(ProfileResponseExtendedCardInfoConfig extendedCardInfoConfig) {
    this.extendedCardInfoConfig = JsonNullable.<ProfileResponseExtendedCardInfoConfig>of(extendedCardInfoConfig);
  }
  ...
  **/
  ...
  public ProfileResponse payoutLinkConfig(ProfileCreatePayoutLinkConfig payoutLinkConfig) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "These key-value pairs are sent as additional custom headers in the outgoing webhook request.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates if tax_calculator connector is enabled or not. If set to `true` tax_connector_id will be checked.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "false", required = true, value = "Indicates if network tokenization is enabled or not.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates if CVV should be collected during payment or not.")
