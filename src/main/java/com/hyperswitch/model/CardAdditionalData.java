 ...
 */
@ApiModel(description = "Masked payout method details for card payout method")
@JsonPropertyOrder({
...
public class CardAdditionalData {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Card type, can be either `credit` or `debit`")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Code for Card issuing bank")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Last 4 digits of the card number")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISIN of the card")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Extended bin of card, contains the first 8 digits of card number")
  @JsonIgnore
  ...
  **/
  ...
  @ApiModelProperty(example = "01", required = true, value = "Card expiry month")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2026", required = true, value = "Card expiry year")
