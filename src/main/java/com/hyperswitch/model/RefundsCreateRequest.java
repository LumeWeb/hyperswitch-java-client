...
public class RefundsCreateRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "pay_mbabizu24mvu3mela5njyhpit4", required = true, value = "The payment id against which refund is initiated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6540", value = "Total amount for which the refund is to be initiated. Amount for the payment in lowest denomination of the currency. (i.e) in cents for USD denomination, in paisa for INR denomination etc., If not provided, this will default to the amount_captured of the payment")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Customer returned the product", value = "Reason for the refund. Often useful for displaying to users and your customer support executive.")
  @JsonIgnore
