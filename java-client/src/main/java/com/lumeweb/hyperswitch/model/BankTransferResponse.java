...
public class BankTransferResponse {
  ...
  /**
   * Return true if this BankTransferResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAch() != null) {
      joiner.add(String.format("%sach%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAch()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `sepa` to the URL query string
    if (getSepa() != null) {
      joiner.add(String.format("%ssepa%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSepa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `bacs` to the URL query string
    if (getBacs() != null) {
      joiner.add(String.format("%sbacs%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBacs()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPermata() != null) {
      joiner.add(String.format("%spermata%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPermata()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `bca` to the URL query string
    if (getBca() != null) {
      joiner.add(String.format("%sbca%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBca()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `bni_va` to the URL query string
    if (getBniVa() != null) {
      joiner.add(String.format("%sbni_va%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBniVa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCimbVa() != null) {
      joiner.add(String.format("%scimb_va%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCimbVa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `danamon_va` to the URL query string
    if (getDanamonVa() != null) {
      joiner.add(String.format("%sdanamon_va%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDanamonVa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `mandiri_va` to the URL query string
    if (getMandiriVa() != null) {
      joiner.add(String.format("%smandiri_va%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMandiriVa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
