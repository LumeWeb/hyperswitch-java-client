 ...
 */
@ApiModel(description = "Required fields info used while listing the payment_method_data")
@JsonPropertyOrder({
...
public class RequiredFieldInfo {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Required field for a payment_method through a payment_method_type")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Display name of the required field in the front-end")
