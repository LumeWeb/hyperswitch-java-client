...
public interface ApiKeyApi extends ApiClient.Api {
  ...
  List<RetrieveApiKeyResponse> listAllAPIKeysAssociatedWithAMerchantAccount(@QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  * but this one also exposes the Http response headers
   ...
   ApiResponse<List<RetrieveApiKeyResponse>> listAllAPIKeysAssociatedWithAMerchantAccountWithHttpInfo(@QueryMap(encoded=true) Map<String, Object> queryParams);
