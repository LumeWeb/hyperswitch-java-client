...
import com.hyperswitch.model.PaymentMethodCollectLinkResponseAllOf;
...
public class PaymentMethodCollectLinkResponse {
  ...
  **/
  ...
  @ApiModelProperty(example = "pm_collect_link_2bdacf398vwzq5n422S1", required = true, value = "The unique identifier for the collect link.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2025-01-18T11:04:09.922Z", required = true, value = "Time when this link will be expired in ISO8601 format")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "https://sandbox.hyperswitch.io/payment_method/collect/pm_collect_link_2bdacf398vwzq5n422S1", required = true, value = "URL to the form's link generated for collecting payment method details.")
