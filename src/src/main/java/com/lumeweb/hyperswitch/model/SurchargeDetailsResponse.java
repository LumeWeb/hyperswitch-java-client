...
public class SurchargeDetailsResponse {
  ...
  /**
   * Return true if this SurchargeDetailsResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDisplaySurchargeAmount() != null) {
      joiner.add(String.format("%sdisplay_surcharge_amount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplaySurchargeAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `display_tax_on_surcharge_amount` to the URL query string
    if (getDisplayTaxOnSurchargeAmount() != null) {
      joiner.add(String.format("%sdisplay_tax_on_surcharge_amount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplayTaxOnSurchargeAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `display_total_surcharge_amount` to the URL query string
    if (getDisplayTotalSurchargeAmount() != null) {
      joiner.add(String.format("%sdisplay_total_surcharge_amount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplayTotalSurchargeAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
