...
import com.lumeweb.hyperswitch.model.ProductType;
...
public class OrderDetailsWithAmount {
  ...
  /**
   * Return true if this OrderDetailsWithAmount object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getProductName() != null) {
      joiner.add(String.format("%sproduct_name%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProductName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getRequiresShipping() != null) {
      joiner.add(String.format("%srequires_shipping%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRequiresShipping()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `product_img_link` to the URL query string
    if (getProductImgLink() != null) {
      joiner.add(String.format("%sproduct_img_link%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProductImgLink()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `product_id` to the URL query string
    if (getProductId() != null) {
      joiner.add(String.format("%sproduct_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProductId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getSubCategory() != null) {
      joiner.add(String.format("%ssub_category%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSubCategory()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getProductType() != null) {
      joiner.add(String.format("%sproduct_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProductType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `product_tax_code` to the URL query string
    if (getProductTaxCode() != null) {
      joiner.add(String.format("%sproduct_tax_code%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProductTaxCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
