...
import com.lumeweb.hyperswitch.model.PaymentMethodList;
import com.lumeweb.hyperswitch.model.PaymentType;
...
public class PaymentMethodListResponse {
  ...
  public PaymentMethodListResponse paymentMethods(@javax.annotation.Nonnull List<PaymentMethodList> paymentMethods) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_METHODS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPaymentMethods(@javax.annotation.Nonnull List<PaymentMethodList> paymentMethods) {
    this.paymentMethods = paymentMethods;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getShowSurchargeBreakupScreen() != null) {
      joiner.add(String.format("%sshow_surcharge_breakup_screen%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getShowSurchargeBreakupScreen()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_type` to the URL query string
    if (getPaymentType() != null) {
      joiner.add(String.format("%spayment_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCollectShippingDetailsFromWallets() != null) {
      joiner.add(String.format("%scollect_shipping_details_from_wallets%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCollectShippingDetailsFromWallets()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `collect_billing_details_from_wallets` to the URL query string
    if (getCollectBillingDetailsFromWallets() != null) {
      joiner.add(String.format("%scollect_billing_details_from_wallets%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCollectBillingDetailsFromWallets()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `is_tax_calculation_enabled` to the URL query string
    if (getIsTaxCalculationEnabled() != null) {
      joiner.add(String.format("%sis_tax_calculation_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsTaxCalculationEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
