...
public class WebhookDetails {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWebhookVersion() != null) {
      joiner.add(String.format("%swebhook_version%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWebhookVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `webhook_username` to the URL query string
    if (getWebhookUsername() != null) {
      joiner.add(String.format("%swebhook_username%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWebhookUsername()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `webhook_password` to the URL query string
    if (getWebhookPassword() != null) {
      joiner.add(String.format("%swebhook_password%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWebhookPassword()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPaymentCreatedEnabled() != null) {
      joiner.add(String.format("%spayment_created_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentCreatedEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_succeeded_enabled` to the URL query string
    if (getPaymentSucceededEnabled() != null) {
      joiner.add(String.format("%spayment_succeeded_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentSucceededEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_failed_enabled` to the URL query string
    if (getPaymentFailedEnabled() != null) {
      joiner.add(String.format("%spayment_failed_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentFailedEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
