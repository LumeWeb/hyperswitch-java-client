...
public class RequestSurchargeDetails {
  ...
  /**
   * Return true if this RequestSurchargeDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTaxAmount() != null) {
      joiner.add(String.format("%stax_amount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTaxAmount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
