...
import com.lumeweb.hyperswitch.model.AttemptStatus;
...
public class PaymentAttemptResponse {
  ...
  /**
   * Return true if this PaymentAttemptResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getModifiedAt() != null) {
      joiner.add(String.format("%smodified_at%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getModifiedAt()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getConnectorMetadata() != null) {
      joiner.add(String.format("%sconnector_metadata%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConnectorMetadata()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `client_source` to the URL query string
    if (getClientSource() != null) {
      joiner.add(String.format("%sclient_source%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getClientSource()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `client_version` to the URL query string
    if (getClientVersion() != null) {
      joiner.add(String.format("%sclient_version%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getClientVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
