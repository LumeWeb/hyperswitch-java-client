 ...
 */
public enum RoutableConnectors {
  ...
  RoutableConnectors(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RoutableConnectors fromValue(String value) {
    for (RoutableConnectors b : RoutableConnectors.values()) {
