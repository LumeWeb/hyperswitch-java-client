...
public class RedirectResponse {
  ...
  /**
   * Return true if this RedirectResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getJsonPayload() != null) {
      joiner.add(String.format("%sjson_payload%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getJsonPayload()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
