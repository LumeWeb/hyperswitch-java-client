...
public class BoletoVoucherData {
  ...
  /**
   * Return true if this BoletoVoucherData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `social_security_number` to the URL query string
    if (getSocialSecurityNumber() != null) {
      joiner.add(String.format("%ssocial_security_number%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSocialSecurityNumber()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
