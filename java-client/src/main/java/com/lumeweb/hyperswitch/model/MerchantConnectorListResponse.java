...
public class MerchantConnectorListResponse {
  ...
  public MerchantConnectorListResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public MerchantConnectorListResponse metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public MerchantConnectorListResponse additionalMerchantData(@javax.annotation.Nullable AdditionalMerchantData additionalMerchantData) {
  ...
  public MerchantConnectorListResponse connectorWalletsDetails(@javax.annotation.Nullable ConnectorWalletDetails connectorWalletsDetails) {
  ...
  /**
   * Return true if this MerchantConnectorListResponse object is equal to o.
   */
  @Override
