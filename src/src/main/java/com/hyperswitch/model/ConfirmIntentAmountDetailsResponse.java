...
public class ConfirmIntentAmountDetailsResponse {
  ...
  /**
   * Return true if this ConfirmIntentAmountDetailsResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `amount_captured` to the URL query string
    if (getAmountCaptured() != null) {
      joiner.add(String.format("%samount_captured%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAmountCaptured()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
