...
import com.lumeweb.hyperswitch.model.PollConfigResponse;
...
public class ThreeDsData {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getThreeDsAuthenticationUrl() != null) {
      joiner.add(String.format("%sthree_ds_authentication_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getThreeDsAuthenticationUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `three_ds_authorize_url` to the URL query string
    if (getThreeDsAuthorizeUrl() != null) {
      joiner.add(String.format("%sthree_ds_authorize_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getThreeDsAuthorizeUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getMessageVersion() != null) {
      joiner.add(String.format("%smessage_version%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMessageVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `directory_server_id` to the URL query string
    if (getDirectoryServerId() != null) {
      joiner.add(String.format("%sdirectory_server_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDirectoryServerId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
