...
import com.lumeweb.hyperswitch.model.CustomerDetails;
import com.lumeweb.hyperswitch.model.PayoutConnectors;
import com.lumeweb.hyperswitch.model.PayoutCreatePayoutLinkConfig;
...
public class PayoutCreateRequest {
  ...
  /**
   * Return true if this PayoutCreateRequest object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConfirm() != null) {
      joiner.add(String.format("%sconfirm%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConfirm()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPayoutToken() != null) {
      joiner.add(String.format("%spayout_token%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayoutToken()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPayoutLink() != null) {
      joiner.add(String.format("%spayout_link%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayoutLink()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
