...
public class PayLaterDataOneOf5 {
  ...
  /**
   * Return true if this PayLaterData_oneOf_5 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PayLaterDataOneOf5 payLaterDataOneOf5 = (PayLaterDataOneOf5) o;
    return Objects.equals(this.walleyRedirect, payLaterDataOneOf5.walleyRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(walleyRedirect);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayLaterDataOneOf5 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWalleyRedirect() != null) {
      joiner.add(String.format("%swalley_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWalleyRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
