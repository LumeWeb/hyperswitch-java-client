...
public class MerchantConnectorDetailsWrap {
  ...
  /**
   * Return true if this MerchantConnectorDetailsWrap object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCredsIdentifier() != null) {
      joiner.add(String.format("%screds_identifier%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCredsIdentifier()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
