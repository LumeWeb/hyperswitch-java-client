...
public class MaskedBankDetails {
  ...
  /**
   * Return true if this MaskedBankDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMask() != null) {
      joiner.add(String.format("%smask%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMask()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
