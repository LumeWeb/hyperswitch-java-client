...
public class GsmUpdateRequest {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "message received from the connector")
  ...
  **/
  ...
  @ApiModelProperty(value = "status provided by the router")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "optional error provided by the router")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "indicates if step_up retry is possible")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "error code unified across the connectors")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "error message unified across the connectors")
  @JsonIgnore
