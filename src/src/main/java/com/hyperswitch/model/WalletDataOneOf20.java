...
public class WalletDataOneOf20 {
  ...
  /**
   * Return true if this WalletData_oneOf_20 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTwintRedirect() != null) {
      joiner.add(String.format("%stwint_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTwintRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
