...
public class BankDebitDataOneOf1SepaBankDebit {
  ...
  **/
  ...
  @ApiModelProperty(example = "DE89370400440532013000", required = true, value = "International bank account number (iban) for SEPA")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "A. Schneider", required = true, value = "Owner name for bank debit")
