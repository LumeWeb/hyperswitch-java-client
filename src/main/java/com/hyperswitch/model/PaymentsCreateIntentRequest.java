...
import com.hyperswitch.model.PaymentsCreateIntentRequestPaymentLinkConfig;
...
public class PaymentsCreateIntentRequest {
  ...
  private JsonNullable<PaymentsCreateIntentRequestPaymentLinkConfig> paymentLinkConfig = JsonNullable.<PaymentsCreateIntentRequestPaymentLinkConfig>undefined();
  ...
  public PaymentsCreateIntentRequest amountDetails(AmountDetails amountDetails) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest merchantReferenceId(String merchantReferenceId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "pay_mbabizu24mvu3mela5njyhpit4", value = "Unique identifier for the payment. This ensures idempotency for multiple payments that have been done by a single merchant.")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest routingAlgorithmId(String routingAlgorithmId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The routing algorithm id to be used for the payment")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest captureMethod(CaptureMethod captureMethod) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest authenticationType(AuthenticationType authenticationType) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest billing(CustomerPaymentMethodBilling billing) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest shipping(CustomerPaymentMethodBilling shipping) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest customerId(String customerId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "cus_y3oqhf46pyzuxjbcn2giaqnb44", value = "The identifier for the customer")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest customerPresent(PresenceOfCustomerDuringPayment customerPresent) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest description(String description) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "It's my first payment request", value = "A description for the payment")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest returnUrl(String returnUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://hyperswitch.io", value = "The URL to which you want the user to be redirected after the completion of the payment operation")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest setupFutureUsage(FutureUsage setupFutureUsage) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest applyMitExemption(MitExemptionRequest applyMitExemption) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest statementDescriptor(String statementDescriptor) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest orderDetails(List<OrderDetailsWithAmount> orderDetails) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[{         \"product_name\": \"Apple iPhone 16\",         \"quantity\": 1,         \"amount\" : 69000         \"product_img_link\" : \"https://dummy-img-link.com\"     }]", value = "Use this object to capture the details about the different products for which the payment is being made. The sum of amount across different products here should be equal to the overall payment amount")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest allowedPaymentMethodTypes(List<PaymentMethodType> allowedPaymentMethodTypes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use this parameter to restrict the Payment Method Types to show for a given PaymentIntent")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest metadata(Object metadata) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest connectorMetadata(PaymentsCreateIntentRequestConnectorMetadata connectorMetadata) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest featureMetadata(PaymentsCreateIntentRequestFeatureMetadata featureMetadata) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest paymentLinkEnabled(EnablePaymentLinkRequest paymentLinkEnabled) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest paymentLinkConfig(PaymentsCreateIntentRequestPaymentLinkConfig paymentLinkConfig) {
    this.paymentLinkConfig = JsonNullable.<PaymentsCreateIntentRequestPaymentLinkConfig>of(paymentLinkConfig);
  ...
  **/
  ...
  public PaymentsCreateIntentRequestPaymentLinkConfig getPaymentLinkConfig() {
  ...
  public JsonNullable<PaymentsCreateIntentRequestPaymentLinkConfig> getPaymentLinkConfig_JsonNullable() {
    return paymentLinkConfig;
  }
  
  @JsonProperty(JSON_PROPERTY_PAYMENT_LINK_CONFIG)
  public void setPaymentLinkConfig_JsonNullable(JsonNullable<PaymentsCreateIntentRequestPaymentLinkConfig> paymentLinkConfig) {
    this.paymentLinkConfig = paymentLinkConfig;
  }

  public void setPaymentLinkConfig(PaymentsCreateIntentRequestPaymentLinkConfig paymentLinkConfig) {
    this.paymentLinkConfig = JsonNullable.<PaymentsCreateIntentRequestPaymentLinkConfig>of(paymentLinkConfig);
  }


  public PaymentsCreateIntentRequest requestIncrementalAuthorization(RequestIncrementalAuthorization requestIncrementalAuthorization) {
  ...
  **/
  ...
  public PaymentsCreateIntentRequest sessionExpiry(Integer sessionExpiry) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "900", value = "Will be used to expire client secret after certain amount of time to be supplied in seconds, if not sent it will be taken from profile config (900) for 15 mins")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest frmMetadata(Object frmMetadata) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Additional data related to some frm(Fraud Risk Management) connectors")
  @JsonIgnore
  ...
  public PaymentsCreateIntentRequest requestExternalThreeDsAuthentication(External3dsAuthenticationRequest requestExternalThreeDsAuthentication) {
