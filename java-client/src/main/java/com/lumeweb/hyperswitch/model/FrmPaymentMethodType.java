...
import com.lumeweb.hyperswitch.model.FrmAction;
import com.lumeweb.hyperswitch.model.FrmPreferredFlowTypes;
...
public class FrmPaymentMethodType {
  ...
  /**
   * Return true if this FrmPaymentMethodType object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCardNetworks() != null) {
      joiner.add(String.format("%scard_networks%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCardNetworks()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
