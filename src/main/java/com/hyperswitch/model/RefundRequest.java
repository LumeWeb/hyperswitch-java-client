...
import com.hyperswitch.model.PaymentsCancelRequestMerchantConnectorDetails;
import com.hyperswitch.model.RefundRequestCharges;
...
public class RefundRequest {
  ...
  private JsonNullable<RefundType> refundType = JsonNullable.<RefundType>undefined();

  public static final String JSON_PROPERTY_METADATA = "metadata";
  private JsonNullable<Object> metadata = JsonNullable.<Object>undefined();

  public static final String JSON_PROPERTY_MERCHANT_CONNECTOR_DETAILS = "merchant_connector_details";
  private JsonNullable<PaymentsCancelRequestMerchantConnectorDetails> merchantConnectorDetails = JsonNullable.<PaymentsCancelRequestMerchantConnectorDetails>undefined();

  public static final String JSON_PROPERTY_CHARGES = "charges";
  private JsonNullable<RefundRequestCharges> charges = JsonNullable.<RefundRequestCharges>undefined();
  ...
  **/
  ...
  @ApiModelProperty(example = "pay_mbabizu24mvu3mela5njyhpit4", required = true, value = "The payment id against which refund is to be initiated")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "y3oqhf46pyzuxjbcn2giaqnb44", value = "The identifier for the Merchant Account")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6540", value = "Total amount for which the refund is to be initiated. Amount for the payment in lowest denomination of the currency. (i.e) in cents for USD denomination, in paisa for INR denomination etc., If not provided, this will default to the full payment amount")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Customer returned the product", value = "Reason for the refund. Often useful for displaying to users and your customer support executive. In case the payment went through Stripe, this field needs to be passed with one of these enums: `duplicate`, `fraudulent`, or `requested_by_customer`")
  @JsonIgnore
  ...
  **/
  ...
  public RefundRequest merchantConnectorDetails(PaymentsCancelRequestMerchantConnectorDetails merchantConnectorDetails) {
    this.merchantConnectorDetails = JsonNullable.<PaymentsCancelRequestMerchantConnectorDetails>of(merchantConnectorDetails);
  ...
  **/
  ...
  public PaymentsCancelRequestMerchantConnectorDetails getMerchantConnectorDetails() {
  ...
  public JsonNullable<PaymentsCancelRequestMerchantConnectorDetails> getMerchantConnectorDetails_JsonNullable() {
    return merchantConnectorDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_MERCHANT_CONNECTOR_DETAILS)
  public void setMerchantConnectorDetails_JsonNullable(JsonNullable<PaymentsCancelRequestMerchantConnectorDetails> merchantConnectorDetails) {
    this.merchantConnectorDetails = merchantConnectorDetails;
  }

  public void setMerchantConnectorDetails(PaymentsCancelRequestMerchantConnectorDetails merchantConnectorDetails) {
    this.merchantConnectorDetails = JsonNullable.<PaymentsCancelRequestMerchantConnectorDetails>of(merchantConnectorDetails);
  }


  public RefundRequest charges(RefundRequestCharges charges) {
    this.charges = JsonNullable.<RefundRequestCharges>of(charges);
  ...
  **/
  ...
  public RefundRequestCharges getCharges() {
  ...
  public JsonNullable<RefundRequestCharges> getCharges_JsonNullable() {
    return charges;
  }
  
  @JsonProperty(JSON_PROPERTY_CHARGES)
  public void setCharges_JsonNullable(JsonNullable<RefundRequestCharges> charges) {
    this.charges = charges;
  }

  public void setCharges(RefundRequestCharges charges) {
    this.charges = JsonNullable.<RefundRequestCharges>of(charges);
  }
