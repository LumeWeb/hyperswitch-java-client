...
public class EphemeralKeyCreateResponse {
  ...
  /**
   * Return true if this EphemeralKeyCreateResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getExpires() != null) {
      joiner.add(String.format("%sexpires%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExpires()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
