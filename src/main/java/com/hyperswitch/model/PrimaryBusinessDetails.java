...
public class PrimaryBusinessDetails {
  ...
  /**
   * Return true if this PrimaryBusinessDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBusiness() != null) {
      joiner.add(String.format("%sbusiness%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBusiness()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
