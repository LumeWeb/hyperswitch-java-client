...
public class NextActionDataOneOf5 {
  ...
  /**
   * Return true if this NextActionData_oneOf_5 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVoucherDetails() != null) {
      joiner.add(String.format("%svoucher_details%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getVoucherDetails()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
