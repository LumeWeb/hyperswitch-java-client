...
public class PaymentsCaptureRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "The unique identifier for the merchant")
  @JsonIgnore
  ...
  **/
  ...
  @ApiModelProperty(example = "6540", required = true, value = "The Amount to be captured/ debited from the user's payment method.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Decider to refund the uncaptured amount")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Provides information about a card payment that customers see on their statements.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Concatenated with the statement descriptor suffix that’s set on the account to form the complete statement descriptor.")
  @JsonIgnore
  ...
  public PaymentsCaptureRequest merchantConnectorDetails(PaymentsCancelRequestMerchantConnectorDetails merchantConnectorDetails) {
