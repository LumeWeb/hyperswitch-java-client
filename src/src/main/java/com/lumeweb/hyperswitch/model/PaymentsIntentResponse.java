...
import com.lumeweb.hyperswitch.model.AmountDetailsResponse;
...
import com.lumeweb.hyperswitch.model.EnablePaymentLinkRequest;
import com.lumeweb.hyperswitch.model.External3dsAuthenticationRequest;
...
import com.lumeweb.hyperswitch.model.MitExemptionRequest;
import com.lumeweb.hyperswitch.model.OrderDetailsWithAmount;
import com.lumeweb.hyperswitch.model.PaymentLinkConfigRequest;
import com.lumeweb.hyperswitch.model.PaymentMethodType;
import com.lumeweb.hyperswitch.model.PresenceOfCustomerDuringPayment;
import com.lumeweb.hyperswitch.model.RequestIncrementalAuthorization;
...
public class PaymentsIntentResponse {
  ...
  public PaymentsIntentResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentsIntentResponse status(@javax.annotation.Nonnull IntentStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PaymentsIntentResponse amountDetails(@javax.annotation.Nonnull AmountDetailsResponse amountDetails) {
  ...
  @JsonProperty(JSON_PROPERTY_AMOUNT_DETAILS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAmountDetails(@javax.annotation.Nonnull AmountDetailsResponse amountDetails) {
    this.amountDetails = amountDetails;
  }


  public PaymentsIntentResponse clientSecret(@javax.annotation.Nonnull String clientSecret) {
  ...
  public PaymentsIntentResponse merchantReferenceId(@javax.annotation.Nullable String merchantReferenceId) {
  ...
  public PaymentsIntentResponse routingAlgorithmId(@javax.annotation.Nullable String routingAlgorithmId) {
  ...
  public PaymentsIntentResponse captureMethod(@javax.annotation.Nonnull CaptureMethod captureMethod) {
  ...
  @JsonProperty(JSON_PROPERTY_CAPTURE_METHOD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCaptureMethod(@javax.annotation.Nonnull CaptureMethod captureMethod) {
    this.captureMethod = captureMethod;
  }


  public PaymentsIntentResponse authenticationType(@javax.annotation.Nonnull AuthenticationType authenticationType) {
  ...
  public PaymentsIntentResponse billing(@javax.annotation.Nullable Address billing) {
  ...
  public PaymentsIntentResponse shipping(@javax.annotation.Nullable Address shipping) {
  ...
  public PaymentsIntentResponse customerId(@javax.annotation.Nullable String customerId) {
  ...
  public PaymentsIntentResponse customerPresent(@javax.annotation.Nonnull PresenceOfCustomerDuringPayment customerPresent) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOMER_PRESENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCustomerPresent(@javax.annotation.Nonnull PresenceOfCustomerDuringPayment customerPresent) {
    this.customerPresent = customerPresent;
  }


  public PaymentsIntentResponse description(@javax.annotation.Nullable String description) {
  ...
  public PaymentsIntentResponse returnUrl(@javax.annotation.Nullable String returnUrl) {
  ...
  public PaymentsIntentResponse setupFutureUsage(@javax.annotation.Nonnull FutureUsage setupFutureUsage) {
  ...
  @JsonProperty(JSON_PROPERTY_SETUP_FUTURE_USAGE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSetupFutureUsage(@javax.annotation.Nonnull FutureUsage setupFutureUsage) {
    this.setupFutureUsage = setupFutureUsage;
  }


  public PaymentsIntentResponse applyMitExemption(@javax.annotation.Nonnull MitExemptionRequest applyMitExemption) {
  ...
  @JsonProperty(JSON_PROPERTY_APPLY_MIT_EXEMPTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setApplyMitExemption(@javax.annotation.Nonnull MitExemptionRequest applyMitExemption) {
    this.applyMitExemption = applyMitExemption;
  }


  public PaymentsIntentResponse statementDescriptor(@javax.annotation.Nullable String statementDescriptor) {
  ...
  public PaymentsIntentResponse orderDetails(@javax.annotation.Nullable List<OrderDetailsWithAmount> orderDetails) {
  ...
  public PaymentsIntentResponse allowedPaymentMethodTypes(@javax.annotation.Nullable List<PaymentMethodType> allowedPaymentMethodTypes) {
  ...
  public PaymentsIntentResponse metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public PaymentsIntentResponse connectorMetadata(@javax.annotation.Nullable ConnectorMetadata connectorMetadata) {
  ...
  public PaymentsIntentResponse featureMetadata(@javax.annotation.Nullable FeatureMetadata featureMetadata) {
  ...
  public PaymentsIntentResponse paymentLinkEnabled(@javax.annotation.Nonnull EnablePaymentLinkRequest paymentLinkEnabled) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_LINK_ENABLED)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPaymentLinkEnabled(@javax.annotation.Nonnull EnablePaymentLinkRequest paymentLinkEnabled) {
    this.paymentLinkEnabled = paymentLinkEnabled;
  }


  public PaymentsIntentResponse paymentLinkConfig(@javax.annotation.Nullable PaymentLinkConfigRequest paymentLinkConfig) {
  ...
  public PaymentsIntentResponse requestIncrementalAuthorization(@javax.annotation.Nonnull RequestIncrementalAuthorization requestIncrementalAuthorization) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUEST_INCREMENTAL_AUTHORIZATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequestIncrementalAuthorization(@javax.annotation.Nonnull RequestIncrementalAuthorization requestIncrementalAuthorization) {
    this.requestIncrementalAuthorization = requestIncrementalAuthorization;
  }


  public PaymentsIntentResponse expiresOn(@javax.annotation.Nonnull OffsetDateTime expiresOn) {
  ...
  public PaymentsIntentResponse frmMetadata(@javax.annotation.Nullable Object frmMetadata) {
  ...
  public PaymentsIntentResponse requestExternalThreeDsAuthentication(@javax.annotation.Nonnull External3dsAuthenticationRequest requestExternalThreeDsAuthentication) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUEST_EXTERNAL_THREE_DS_AUTHENTICATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequestExternalThreeDsAuthentication(@javax.annotation.Nonnull External3dsAuthenticationRequest requestExternalThreeDsAuthentication) {
    this.requestExternalThreeDsAuthentication = requestExternalThreeDsAuthentication;
  }


  /**
   * Return true if this PaymentsIntentResponse object is equal to o.
   */
  @Override
