...
public class PaymentChargeResponse {
  ...
  /**
   * Return true if this PaymentChargeResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `application_fees` to the URL query string
    if (getApplicationFees() != null) {
      joiner.add(String.format("%sapplication_fees%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getApplicationFees()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `transfer_account_id` to the URL query string
    if (getTransferAccountId() != null) {
      joiner.add(String.format("%stransfer_account_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTransferAccountId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
