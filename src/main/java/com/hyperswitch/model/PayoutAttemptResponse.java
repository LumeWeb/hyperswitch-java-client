...
public class PayoutAttemptResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6583", required = true, value = "The payout attempt amount. Amount for the payout in lowest denomination of the currency. (i.e) in cents for USD denomination, in paisa for INR denomination etc.,")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The connector used for the payout")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Connector's error code in case of failures")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Connector's error message in case of failures")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A unique identifier for a payout provided by the connector")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If the payout was cancelled the reason provided here")
  @JsonIgnore
