...
public class PaymentAttemptResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Unique identifier for the attempt")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6540", required = true, value = "The payment attempt amount. Amount for the payment in lowest denomination of the currency. (i.e) in cents for USD denomination, in paisa for INR denomination etc.,")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The connector used for the payment")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A unique identifier for a payment provided by the connector")
  @JsonIgnore
  ...
  **/
  ...
  public PaymentAttemptResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-10T10:11:12Z", required = true, value = "Time at which the payment attempt was created")
  ...
  public PaymentAttemptResponse modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-10T10:11:12Z", required = true, value = "Time at which the payment attempt was last modified")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A unique identifier to link the payment to a mandate, can be use instead of payment_method_data")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If there was an error while calling the connectors the error code is received here")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Provide a reference to a stored payment method")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Additional data related to some connectors")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "993672945374576J", value = "Reference to the payment at connector side")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "(This field is not live yet)Error code unified across the connectors is received here if there was an error while calling connector")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "(This field is not live yet)Error message unified across the connectors is received here if there was an error while calling connector")
  @JsonIgnore
  ...
  public PaymentAttemptResponse clientSource(String clientSource) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Value passed in X-CLIENT-SOURCE header during payments confirm request by the client")
  @JsonIgnore
  ...
  public PaymentAttemptResponse clientVersion(String clientVersion) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Value passed in X-CLIENT-VERSION header during payments confirm request by the client")
  @JsonIgnore
