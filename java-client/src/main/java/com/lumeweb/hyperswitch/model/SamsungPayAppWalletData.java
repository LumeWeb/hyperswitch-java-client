...
public class SamsungPayAppWalletData {
  ...
  /**
   * Return true if this SamsungPayAppWalletData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPaymentCardBrand() != null) {
      joiner.add(String.format("%spayment_card_brand%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentCardBrand()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_currency_type` to the URL query string
    if (getPaymentCurrencyType() != null) {
      joiner.add(String.format("%spayment_currency_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentCurrencyType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_last4_dpan` to the URL query string
    if (getPaymentLast4Dpan() != null) {
      joiner.add(String.format("%spayment_last4_dpan%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentLast4Dpan()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment_last4_fpan` to the URL query string
    if (getPaymentLast4Fpan() != null) {
      joiner.add(String.format("%spayment_last4_fpan%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaymentLast4Fpan()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `merchant_ref` to the URL query string
    if (getMerchantRef() != null) {
      joiner.add(String.format("%smerchant_ref%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMerchantRef()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
