...
public class WalletDataOneOf6 {
  ...
  /**
   * Return true if this WalletData_oneOf_6 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGcashRedirect() != null) {
      joiner.add(String.format("%sgcash_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getGcashRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
