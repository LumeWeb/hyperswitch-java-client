...
public class RoutingDictionary {
  ...
  /**
   * Return true if this RoutingDictionary object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActiveId() != null) {
      joiner.add(String.format("%sactive_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getActiveId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
