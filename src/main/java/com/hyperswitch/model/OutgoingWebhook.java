...
public class OutgoingWebhook {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The merchant id of the merchant")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The unique event id for each webhook")
  ...
  **/
  ...
  @ApiModelProperty(value = "The time at which webhook was sent")
