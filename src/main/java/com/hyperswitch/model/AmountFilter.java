...
public class AmountFilter {
  ...
  **/
  ...
  @ApiModelProperty(value = "The start amount to filter list of transactions which are greater than or equal to the start amount")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The end amount to filter list of transactions which are less than or equal to the end amount")
  @JsonIgnore
