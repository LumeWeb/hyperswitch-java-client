...
public class WalletDataOneOf22 {
  ...
  /**
   * Return true if this WalletData_oneOf_22 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WalletDataOneOf22 walletDataOneOf22 = (WalletDataOneOf22) o;
    return Objects.equals(this.touchNGoRedirect, walletDataOneOf22.touchNGoRedirect);
  }
  ...
  public String toString() {
    ...
    sb.append("class WalletDataOneOf22 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTouchNGoRedirect() != null) {
      joiner.add(String.format("%stouch_n_go_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTouchNGoRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
