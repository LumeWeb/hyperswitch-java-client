...
public class WalletDataOneOf21 {
  ...
  /**
   * Return true if this WalletData_oneOf_21 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.vippsRedirect, walletDataOneOf21.vippsRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vippsRedirect);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVippsRedirect() != null) {
      joiner.add(String.format("%svipps_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getVippsRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
