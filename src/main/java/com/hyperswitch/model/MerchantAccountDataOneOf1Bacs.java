...
public class MerchantAccountDataOneOf1Bacs {
  ...
  /**
   * Return true if this MerchantAccountData_oneOf_1_bacs object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConnectorRecipientId() != null) {
      joiner.add(String.format("%sconnector_recipient_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConnectorRecipientId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
