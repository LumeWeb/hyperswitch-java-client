...
/**
 * ProfileCreateWebhookDetails
 */
@JsonPropertyOrder({
  ProfileCreateWebhookDetails.JSON_PROPERTY_WEBHOOK_VERSION,
  ProfileCreateWebhookDetails.JSON_PROPERTY_WEBHOOK_USERNAME,
  ProfileCreateWebhookDetails.JSON_PROPERTY_WEBHOOK_PASSWORD,
  ProfileCreateWebhookDetails.JSON_PROPERTY_WEBHOOK_URL,
  ProfileCreateWebhookDetails.JSON_PROPERTY_PAYMENT_CREATED_ENABLED,
  ProfileCreateWebhookDetails.JSON_PROPERTY_PAYMENT_SUCCEEDED_ENABLED,
  ProfileCreateWebhookDetails.JSON_PROPERTY_PAYMENT_FAILED_ENABLED
})
@JsonTypeName("ProfileCreate_webhook_details")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ProfileCreateWebhookDetails {
  ...
  public ProfileCreateWebhookDetails() { 
  }

  public ProfileCreateWebhookDetails webhookVersion(String webhookVersion) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1.0.2", value = "The version for Webhook")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails webhookUsername(String webhookUsername) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ekart_retail", value = "The user name for Webhook login")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails webhookPassword(String webhookPassword) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ekart@123", value = "The password for Webhook login")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails webhookUrl(String webhookUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "www.ekart.com/webhooks", value = "The url for the webhook endpoint")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails paymentCreatedEnabled(Boolean paymentCreatedEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "If this property is true, a webhook message is posted whenever a new payment is created")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails paymentSucceededEnabled(Boolean paymentSucceededEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "If this property is true, a webhook message is posted whenever a payment is successful")
  @JsonIgnore
  ...
  public ProfileCreateWebhookDetails paymentFailedEnabled(Boolean paymentFailedEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "If this property is true, a webhook message is posted whenever a payment fails")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    ProfileCreateWebhookDetails profileCreateWebhookDetails = (ProfileCreateWebhookDetails) o;
    return equalsNullable(this.webhookVersion, profileCreateWebhookDetails.webhookVersion) &&
        equalsNullable(this.webhookUsername, profileCreateWebhookDetails.webhookUsername) &&
        equalsNullable(this.webhookPassword, profileCreateWebhookDetails.webhookPassword) &&
        equalsNullable(this.webhookUrl, profileCreateWebhookDetails.webhookUrl) &&
        equalsNullable(this.paymentCreatedEnabled, profileCreateWebhookDetails.paymentCreatedEnabled) &&
        equalsNullable(this.paymentSucceededEnabled, profileCreateWebhookDetails.paymentSucceededEnabled) &&
        equalsNullable(this.paymentFailedEnabled, profileCreateWebhookDetails.paymentFailedEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProfileCreateWebhookDetails {\n");
