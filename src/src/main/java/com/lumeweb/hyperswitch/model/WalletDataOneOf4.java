...
public class WalletDataOneOf4 {
  ...
  /**
   * Return true if this WalletData_oneOf_4 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WalletDataOneOf4 walletDataOneOf4 = (WalletDataOneOf4) o;
    return Objects.equals(this.kakaoPayRedirect, walletDataOneOf4.kakaoPayRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kakaoPayRedirect);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletDataOneOf4 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getKakaoPayRedirect() != null) {
      joiner.add(String.format("%skakao_pay_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getKakaoPayRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
