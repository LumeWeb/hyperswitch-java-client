...
public class AmountInfo {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The label must be the name of the merchant.")
  ...
  **/
  ...
  @ApiModelProperty(value = "A value that indicates whether the line item(Ex: total, tax, discount, or grand total) is final or pending.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "38.02", required = true, value = "The total amount for the payment in majot unit string (Ex: 38.02)")
