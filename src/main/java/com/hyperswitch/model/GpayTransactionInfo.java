...
public class GpayTransactionInfo {
  ...
  /**
   * Return true if this GpayTransactionInfo object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTotalPriceStatus() != null) {
      joiner.add(String.format("%stotal_price_status%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTotalPriceStatus()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `total_price` to the URL query string
    if (getTotalPrice() != null) {
      joiner.add(String.format("%stotal_price%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTotalPrice()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
