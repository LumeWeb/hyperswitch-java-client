...
public class MerchantConnectorWebhookDetails {
  ...
  /**
   * Return true if this MerchantConnectorWebhookDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMerchantSecret() != null) {
      joiner.add(String.format("%smerchant_secret%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMerchantSecret()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `additional_secret` to the URL query string
    if (getAdditionalSecret() != null) {
      joiner.add(String.format("%sadditional_secret%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAdditionalSecret()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
