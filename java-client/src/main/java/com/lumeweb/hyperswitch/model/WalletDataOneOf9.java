...
public class WalletDataOneOf9 {
  ...
  /**
   * Return true if this WalletData_oneOf_9 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getApplePayThirdPartySdk() != null) {
      joiner.add(String.format("%sapple_pay_third_party_sdk%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getApplePayThirdPartySdk()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
