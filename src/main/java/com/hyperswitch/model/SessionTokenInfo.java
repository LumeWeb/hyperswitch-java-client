...
import com.hyperswitch.model.SessionTokenInfoAllOf;
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ApplepayConnectorMetadataRequestSessionTokenData.class, name = "ApplepayConnectorMetadataRequest_session_token_data"),
})
