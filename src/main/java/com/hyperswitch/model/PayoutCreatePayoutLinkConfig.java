...
import com.hyperswitch.model.PayoutCreatePayoutLinkConfigAllOf;
 ...
 */
@ApiModel(description = "Custom payout link config for the particular payout, if payout link is to be generated.")
@JsonPropertyOrder({
