...
public class BankRedirectBilling {
  ...
  **/
  ...
  @ApiModelProperty(example = "John Doe", required = true, value = "The name for which billing is issued")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "example@example.com", required = true, value = "The billing email for bank redirect")
