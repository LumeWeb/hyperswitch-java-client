...
import com.lumeweb.hyperswitch.model.EnabledPaymentMethod;
import com.lumeweb.hyperswitch.model.UIWidgetFormLayout;
...
public class PayoutCreatePayoutLinkConfig {
  ...
  /**
   * Return true if this PayoutCreatePayoutLinkConfig object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFormLayout() != null) {
      joiner.add(String.format("%sform_layout%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFormLayout()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `test_mode` to the URL query string
    if (getTestMode() != null) {
      joiner.add(String.format("%stest_mode%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTestMode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
