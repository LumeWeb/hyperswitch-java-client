...
public class ToggleKVResponse {
  ...
  /**
   * Return true if this ToggleKVResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getKvEnabled() != null) {
      joiner.add(String.format("%skv_enabled%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getKvEnabled()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
