...
public class GooglePayAssuranceDetails {
  ...
  /**
   * Return true if this GooglePayAssuranceDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCardHolderAuthenticated() != null) {
      joiner.add(String.format("%scard_holder_authenticated%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCardHolderAuthenticated()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `account_verified` to the URL query string
    if (getAccountVerified() != null) {
      joiner.add(String.format("%saccount_verified%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAccountVerified()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
