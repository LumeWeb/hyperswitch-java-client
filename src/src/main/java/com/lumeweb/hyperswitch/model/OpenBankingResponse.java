...
public class OpenBankingResponse {
  ...
  /**
   * Return true if this OpenBankingResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OpenBankingResponse openBankingResponse = (OpenBankingResponse) o;
    return Objects.equals(this.openBankingPis, openBankingResponse.openBankingPis);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpenBankingResponse {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOpenBankingPis() != null) {
      joiner.add(String.format("%sopen_banking_pis%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOpenBankingPis()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
