...
public class BankRedirectDataOneOf13Sofort {
  ...
  /**
   * Return true if this BankRedirectData_oneOf_13_sofort object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPreferredLanguage() != null) {
      joiner.add(String.format("%spreferred_language%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPreferredLanguage()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
