...
import com.hyperswitch.model.RequestPaymentMethodTypes;
 ...
 */
@ApiModel(description = "Details of all the payment methods enabled for the connector for the given merchant account")
@JsonPropertyOrder({
...
public class PaymentMethodsEnabled {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"credit\"]", value = "Subtype of payment method")
  @JsonIgnore
