 ...
 */
@ApiModel(description = "The response information (headers, body and status code) received for the webhook sent.")
@JsonPropertyOrder({
...
public class OutgoingWebhookResponseContent {
  ...
  private JsonNullable<List<List<String>>> headers = JsonNullable.<List<List<String>>>undefined();
  ...
  **/
  ...
  @ApiModelProperty(value = "The response body received for the webhook sent.")
  @JsonIgnore
  ...
  public OutgoingWebhookResponseContent headers(List<List<String>> headers) {
    this.headers = JsonNullable.<List<List<String>>>of(headers);
    
    return this;
  }

  public OutgoingWebhookResponseContent addHeadersItem(List<String> headersItem) {
    if (this.headers == null || !this.headers.isPresent()) {
      this.headers = JsonNullable.<List<List<String>>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[[\"content-type\",\"application/json\"],[\"content-length\",\"1024\"]]", value = "The response headers received for the webhook sent.")
  @JsonIgnore
  ...
  public JsonNullable<List<List<String>>> getHeaders_JsonNullable() {
    return headers;
  }
  
  @JsonProperty(JSON_PROPERTY_HEADERS)
  public void setHeaders_JsonNullable(JsonNullable<List<List<String>>> headers) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "200", value = "The HTTP status code for the webhook sent.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "200", value = "Error message in case any error occurred when trying to deliver the webhook.")
  @JsonIgnore
