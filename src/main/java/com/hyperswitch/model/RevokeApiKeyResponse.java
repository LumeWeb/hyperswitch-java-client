 ...
 */
@ApiModel(description = "The response body for revoking an API Key.")
@JsonPropertyOrder({
...
public class RevokeApiKeyResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "Indicates whether the API key was revoked or not.")
