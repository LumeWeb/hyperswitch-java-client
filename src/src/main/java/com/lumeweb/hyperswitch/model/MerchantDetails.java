...
public class MerchantDetails {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPrimaryContactPerson() != null) {
      joiner.add(String.format("%sprimary_contact_person%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPrimaryContactPerson()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `primary_phone` to the URL query string
    if (getPrimaryPhone() != null) {
      joiner.add(String.format("%sprimary_phone%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPrimaryPhone()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `primary_email` to the URL query string
    if (getPrimaryEmail() != null) {
      joiner.add(String.format("%sprimary_email%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPrimaryEmail()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `secondary_contact_person` to the URL query string
    if (getSecondaryContactPerson() != null) {
      joiner.add(String.format("%ssecondary_contact_person%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSecondaryContactPerson()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `secondary_phone` to the URL query string
    if (getSecondaryPhone() != null) {
      joiner.add(String.format("%ssecondary_phone%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSecondaryPhone()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `secondary_email` to the URL query string
    if (getSecondaryEmail() != null) {
      joiner.add(String.format("%ssecondary_email%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSecondaryEmail()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getAboutBusiness() != null) {
      joiner.add(String.format("%sabout_business%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAboutBusiness()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
