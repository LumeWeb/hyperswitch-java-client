...
public class MandateData {
  ...
  /**
   * Return true if this MandateData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUpdateMandateId() != null) {
      joiner.add(String.format("%supdate_mandate_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUpdateMandateId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
