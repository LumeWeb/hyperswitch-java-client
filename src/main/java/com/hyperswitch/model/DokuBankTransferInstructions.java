...
public class DokuBankTransferInstructions {
  ...
  /**
   * Return true if this DokuBankTransferInstructions object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInstructionsUrl() != null) {
      joiner.add(String.format("%sinstructions_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getInstructionsUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
