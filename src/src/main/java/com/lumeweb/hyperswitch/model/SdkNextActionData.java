...
import com.lumeweb.hyperswitch.model.NextActionCall;
...
public class SdkNextActionData {
  ...
  /**
   * Return true if this SdkNextActionData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNextAction() != null) {
      joiner.add(String.format("%snext_action%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getNextAction()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `order_id` to the URL query string
    if (getOrderId() != null) {
      joiner.add(String.format("%sorder_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getOrderId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
