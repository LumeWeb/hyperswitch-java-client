...
public class WalletDataOneOf26 {
  ...
  /**
   * Return true if this WalletData_oneOf_26 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSwishQr() != null) {
      joiner.add(String.format("%sswish_qr%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSwishQr()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
