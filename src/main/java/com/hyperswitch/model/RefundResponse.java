...
import com.hyperswitch.model.RefundResponseErrorDetails;
...
public class RefundResponse {
  ...
  private JsonNullable<RefundResponseErrorDetails> errorDetails = JsonNullable.<RefundResponseErrorDetails>undefined();
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Global Refund Id for the refund")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The payment id against which refund is initiated")
  ...
  public RefundResponse merchantReferenceId(String merchantReferenceId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "ref_mbabizu24mvu3mela5njyhpit4", value = "Unique Identifier for the Refund. This is to ensure idempotency for multiple partial refunds initiated against the same payment.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6540", required = true, value = "The refund amount")
  ...
  public RefundResponse currency(Currency currency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An arbitrary string attached to the object")
  @JsonIgnore
  ...
  **/
  ...
  public RefundResponse errorDetails(RefundResponseErrorDetails errorDetails) {
    this.errorDetails = JsonNullable.<RefundResponseErrorDetails>of(errorDetails);
  ...
  **/
  ...
  public RefundResponseErrorDetails getErrorDetails() {
  ...
  public JsonNullable<RefundResponseErrorDetails> getErrorDetails_JsonNullable() {
    return errorDetails;
  }
  
  @JsonProperty(JSON_PROPERTY_ERROR_DETAILS)
  public void setErrorDetails_JsonNullable(JsonNullable<RefundResponseErrorDetails> errorDetails) {
    this.errorDetails = errorDetails;
  }

  public void setErrorDetails(RefundResponseErrorDetails errorDetails) {
    this.errorDetails = JsonNullable.<RefundResponseErrorDetails>of(errorDetails);
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The timestamp at which refund is created")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The timestamp at which refund is updated")
  ...
  public RefundResponse connector(Connector connector) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The id of business profile for this refund")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The merchant_connector_id of the processor through which this payment went through")
  ...
  public RefundResponse connectorRefundReferenceId(String connectorRefundReferenceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reference id of the connector for the refund")
  @JsonIgnore
  ...
  public void setConnectorRefundReferenceId(String connectorRefundReferenceId) {
    this.connectorRefundReferenceId = JsonNullable.<String>of(connectorRefundReferenceId);
  }
