...
public class RefundUpdateRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Customer returned the product", value = "An arbitrary string attached to the object. Often useful for displaying to users and your customer support executive")
  @JsonIgnore
