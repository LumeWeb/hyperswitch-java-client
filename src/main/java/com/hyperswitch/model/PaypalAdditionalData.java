 ...
 */
@JsonPropertyOrder({
  PaypalAdditionalData.JSON_PROPERTY_EMAIL,
  PaypalAdditionalData.JSON_PROPERTY_TELEPHONE_NUMBER,
  PaypalAdditionalData.JSON_PROPERTY_PAYPAL_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0-SNAPSHOT")
public class PaypalAdditionalData {
  ...
  public PaypalAdditionalData() { 
  }

  public PaypalAdditionalData email(@javax.annotation.Nullable String email) {
  ...
  public PaypalAdditionalData telephoneNumber(@javax.annotation.Nullable String telephoneNumber) {
  ...
  public PaypalAdditionalData paypalId(@javax.annotation.Nullable String paypalId) {
  ...
  /**
   * Return true if this PaypalAdditionalData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PaypalAdditionalData paypalAdditionalData = (PaypalAdditionalData) o;
    return equalsNullable(this.email, paypalAdditionalData.email) &&
        equalsNullable(this.telephoneNumber, paypalAdditionalData.telephoneNumber) &&
        equalsNullable(this.paypalId, paypalAdditionalData.paypalId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaypalAdditionalData {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPaypalId() != null) {
      joiner.add(String.format("%spaypal_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaypalId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
