...
public class Comparison {
  ...
  /**
   * Return true if this Comparison object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLhs() != null) {
      joiner.add(String.format("%slhs%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getLhs()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `comparison` to the URL query string
    if (getComparison() != null) {
      joiner.add(String.format("%scomparison%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getComparison()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
