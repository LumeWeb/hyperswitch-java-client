 ...
 */
@ApiModel(description = "The request body for creating an API Key.")
@JsonPropertyOrder({
...
public class CreateApiKeyRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Sandbox integration key", required = true, value = "A unique name for the API Key to help you identify it.")
