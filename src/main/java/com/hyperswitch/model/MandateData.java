 ...
 */
@ApiModel(description = "Passing this object during payments creates a mandate. The mandate_type sub object is passed by the server.")
@JsonPropertyOrder({
...
public class MandateData {
  ...
  **/
  ...
  public MandateData customerAcceptance(MandateDataCustomerAcceptance customerAcceptance) {
  ...
  **/
  ...
  public MandateData mandateType(MandateDataMandateType mandateType) {
