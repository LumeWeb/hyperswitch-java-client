...
import com.hyperswitch.model.PayoutListConstraintsAllOf;
...
public class PayoutListConstraints {
  ...
  public PayoutListConstraints customerId(String customerId) {
  ...
  **/
  ...
  public PayoutListConstraints startingAfter(String startingAfter) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "pay_fafa124123", value = "A cursor for use in pagination, fetch the next list after some object")
  @JsonIgnore
  ...
  public PayoutListConstraints endingBefore(String endingBefore) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "pay_fafa124123", value = "A cursor for use in pagination, fetch the previous list before some object")
  @JsonIgnore
  ...
  public PayoutListConstraints limit(Integer limit) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "limit on the number of objects to return")
  ...
  public PayoutListConstraints created(OffsetDateTime created) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-09-10T10:11:12Z", value = "The time at which payout is created")
  @JsonIgnore
  ...
  public PayoutListConstraints startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The start time to filter payments list or to get list of filters. To get list of filters start time is needed to be passed")
  ...
  public PayoutListConstraints endTime(OffsetDateTime endTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The end time to filter payments list or to get list of filters. If not passed the default time is now")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.customerId, payoutListConstraints.customerId) &&
        ...
        Objects.equals(this.startTime, payoutListConstraints.startTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(customerId), hashCodeNullable(startingAfter), hashCodeNullable(endingBefore), limit, hashCodeNullable(created), startTime, hashCodeNullable(endTime));
  }
