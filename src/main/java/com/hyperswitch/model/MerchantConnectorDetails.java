...
public class MerchantConnectorDetails {
  ...
  /**
   * Return true if this MerchantConnectorDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConnectorAccountDetails() != null) {
      joiner.add(String.format("%sconnector_account_details%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConnectorAccountDetails()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
