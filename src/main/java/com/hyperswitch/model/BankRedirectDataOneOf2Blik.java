...
public class BankRedirectDataOneOf2Blik {
  ...
  /**
   * Return true if this BankRedirectData_oneOf_2_blik object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BankRedirectDataOneOf2Blik bankRedirectDataOneOf2Blik = (BankRedirectDataOneOf2Blik) o;
    return equalsNullable(this.blikCode, bankRedirectDataOneOf2Blik.blikCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankRedirectDataOneOf2Blik {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBlikCode() != null) {
      joiner.add(String.format("%sblik_code%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBlikCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
