...
public class ConnectorWalletDetails {
  ...
  /**
   * Return true if this ConnectorWalletDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getApplePayCombined() != null) {
      joiner.add(String.format("%sapple_pay_combined%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getApplePayCombined()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `apple_pay` to the URL query string
    if (getApplePay() != null) {
      joiner.add(String.format("%sapple_pay%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getApplePay()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `samsung_pay` to the URL query string
    if (getSamsungPay() != null) {
      joiner.add(String.format("%ssamsung_pay%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSamsungPay()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `paze` to the URL query string
    if (getPaze() != null) {
      joiner.add(String.format("%spaze%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPaze()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
