...
public class PayLaterDataOneOf7 {
  ...
  /**
   * Return true if this PayLaterData_oneOf_7 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAtomeRedirect() != null) {
      joiner.add(String.format("%satome_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAtomeRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
