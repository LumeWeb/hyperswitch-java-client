 ...
 */
@ApiModel(description = "Payment Method data for Ach bank debit")
@JsonPropertyOrder({
...
public class BankDebitDataOneOfAchBankDebit {
  ...
  **/
  ...
  @ApiModelProperty(example = "000123456789", required = true, value = "Account number for ach bank debit payment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "110000000", required = true, value = "Routing number for ach bank debit payment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "John Test", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ACH", required = true, value = "")
