...
public class PaymentsIntentResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Global Payment Id for the payment")
  ...
  **/
  ...
  public PaymentsIntentResponse billing(CustomerPaymentMethodBilling billing) {
  ...
  **/
  ...
  public PaymentsIntentResponse shipping(CustomerPaymentMethodBilling shipping) {
  ...
  **/
  ...
  public PaymentsIntentResponse connectorMetadata(PaymentsCreateIntentRequestConnectorMetadata connectorMetadata) {
  ...
  **/
  ...
  public PaymentsIntentResponse featureMetadata(PaymentsCreateIntentRequestFeatureMetadata featureMetadata) {
  ...
  **/
  ...
  public PaymentsIntentResponse paymentLinkConfig(PaymentsCreateIntentRequestPaymentLinkConfig paymentLinkConfig) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Will be used to expire client secret after certain amount of time to be supplied in seconds")
