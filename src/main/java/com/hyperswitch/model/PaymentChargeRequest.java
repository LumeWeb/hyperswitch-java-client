...
public class PaymentChargeRequest {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "6540", required = true, value = "Platform fees to be collected on the payment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Identifier for the reseller's account to send the funds to")
