...
import com.hyperswitch.model.MandateCardDetails;
 ...
 */
@JsonPropertyOrder({
  MandateResponseCard.JSON_PROPERTY_LAST4_DIGITS,
  MandateResponseCard.JSON_PROPERTY_CARD_EXP_MONTH,
  MandateResponseCard.JSON_PROPERTY_CARD_EXP_YEAR,
  MandateResponseCard.JSON_PROPERTY_CARD_HOLDER_NAME,
  MandateResponseCard.JSON_PROPERTY_CARD_TOKEN,
  MandateResponseCard.JSON_PROPERTY_SCHEME,
  MandateResponseCard.JSON_PROPERTY_ISSUER_COUNTRY,
  MandateResponseCard.JSON_PROPERTY_CARD_FINGERPRINT,
  MandateResponseCard.JSON_PROPERTY_CARD_ISIN,
  MandateResponseCard.JSON_PROPERTY_CARD_ISSUER,
  MandateResponseCard.JSON_PROPERTY_CARD_NETWORK,
  MandateResponseCard.JSON_PROPERTY_CARD_TYPE,
  MandateResponseCard.JSON_PROPERTY_NICK_NAME
})
@JsonTypeName("MandateResponse_card")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MandateResponseCard {
  ...
  public MandateResponseCard() { 
  }

  public MandateResponseCard last4Digits(String last4Digits) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The last 4 digits of card")
  @JsonIgnore
  ...
  public MandateResponseCard cardExpMonth(String cardExpMonth) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The expiry month of card")
  @JsonIgnore
  ...
  public MandateResponseCard cardExpYear(String cardExpYear) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The expiry year of card")
  @JsonIgnore
  ...
  public MandateResponseCard cardHolderName(String cardHolderName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The card holder name")
  @JsonIgnore
  ...
  public MandateResponseCard cardToken(String cardToken) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The token from card locker")
  @JsonIgnore
  ...
  public MandateResponseCard scheme(String scheme) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The card scheme network for the particular card")
  @JsonIgnore
  ...
  public MandateResponseCard issuerCountry(String issuerCountry) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The country code in in which the card was issued")
  @JsonIgnore
  ...
  public MandateResponseCard cardFingerprint(String cardFingerprint) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A unique identifier alias to identify a particular card")
  @JsonIgnore
  ...
  public MandateResponseCard cardIsin(String cardIsin) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The first 6 digits of card")
  @JsonIgnore
  ...
  public MandateResponseCard cardIssuer(String cardIssuer) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The bank that issued the card")
  @JsonIgnore
  ...
  public MandateResponseCard cardNetwork(CardNetwork cardNetwork) {
  ...
  **/
  ...
  public MandateResponseCard cardType(String cardType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the payment card")
  @JsonIgnore
  ...
  public MandateResponseCard nickName(String nickName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The nick_name of the card holder")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    MandateResponseCard mandateResponseCard = (MandateResponseCard) o;
    return equalsNullable(this.last4Digits, mandateResponseCard.last4Digits) &&
        equalsNullable(this.cardExpMonth, mandateResponseCard.cardExpMonth) &&
        equalsNullable(this.cardExpYear, mandateResponseCard.cardExpYear) &&
        equalsNullable(this.cardHolderName, mandateResponseCard.cardHolderName) &&
        equalsNullable(this.cardToken, mandateResponseCard.cardToken) &&
        equalsNullable(this.scheme, mandateResponseCard.scheme) &&
        equalsNullable(this.issuerCountry, mandateResponseCard.issuerCountry) &&
        equalsNullable(this.cardFingerprint, mandateResponseCard.cardFingerprint) &&
        equalsNullable(this.cardIsin, mandateResponseCard.cardIsin) &&
        equalsNullable(this.cardIssuer, mandateResponseCard.cardIssuer) &&
        equalsNullable(this.cardNetwork, mandateResponseCard.cardNetwork) &&
        equalsNullable(this.cardType, mandateResponseCard.cardType) &&
        equalsNullable(this.nickName, mandateResponseCard.nickName);
  }
  ...
  public String toString() {
    ...
    sb.append("class MandateResponseCard {\n");
