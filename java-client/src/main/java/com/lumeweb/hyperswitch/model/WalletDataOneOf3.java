...
public class WalletDataOneOf3 {
  ...
  /**
   * Return true if this WalletData_oneOf_3 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WalletDataOneOf3 walletDataOneOf3 = (WalletDataOneOf3) o;
    return Objects.equals(this.momoRedirect, walletDataOneOf3.momoRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(momoRedirect);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletDataOneOf3 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMomoRedirect() != null) {
      joiner.add(String.format("%smomo_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMomoRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
