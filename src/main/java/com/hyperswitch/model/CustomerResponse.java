...
public class CustomerResponse {
  ...
  **/
  ...
  @ApiModelProperty(example = "cus_y3oqhf46pyzuxjbcn2giaqnb44", required = true, value = "The identifier for the customer object")
  ...
  **/
  ...
  @ApiModelProperty(example = "Jon Test", value = "The customer's name")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "JonTest@test.com", value = "The customer's email address")
  @JsonIgnore
  ...
  **/
  ...
  public CustomerResponse defaultBillingAddress(AddressAddress defaultBillingAddress) {
  ...
  **/
  ...
  public CustomerResponse defaultShippingAddress(AddressAddress defaultShippingAddress) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2023-01-18T11:04:09.922Z", required = true, value = "A timestamp (ISO 8601 code) that determines when the customer was created")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "pm_djh2837dwduh890123", value = "The identifier for the default payment method.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Global id")
