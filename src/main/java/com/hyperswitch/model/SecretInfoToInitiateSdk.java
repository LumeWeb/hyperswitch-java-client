...
public class SecretInfoToInitiateSdk {
  ...
  /**
   * Return true if this SecretInfoToInitiateSdk object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDisplay() != null) {
      joiner.add(String.format("%sdisplay%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplay()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `payment` to the URL query string
    if (getPayment() != null) {
      joiner.add(String.format("%spayment%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPayment()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
