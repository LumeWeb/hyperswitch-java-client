 ...
 */
@ApiModel(description = "The response body for creating an API Key.")
@JsonPropertyOrder({
...
public class CreateApiKeyResponse {
  ...
  **/
  ...
  @ApiModelProperty(example = "5hEEqkgJUyuxgSKGArHA4mWSnX", required = true, value = "The identifier for the API Key.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Sandbox integration key", required = true, value = "The unique name for the API Key to help you identify it.")
  ...
  **/
  ...
  @ApiModelProperty(example = "Key used by our developers to integrate with the sandbox environment", value = "The description to provide more context about the API Key.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The plaintext API Key used for server-side API access. Ensure you store the API Key securely as you will not be able to see it again.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-10T10:11:12Z", required = true, value = "The time at which the API Key was created.")
