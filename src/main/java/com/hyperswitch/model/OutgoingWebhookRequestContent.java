 ...
 */
@ApiModel(description = "The request information (headers and body) sent in the webhook.")
@JsonPropertyOrder({
...
public class OutgoingWebhookRequestContent {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The request body sent in the webhook.")
  ...
  public OutgoingWebhookRequestContent headers(List<List<String>> headers) {
    
    this.headers = headers;
    return this;
  }

  public OutgoingWebhookRequestContent addHeadersItem(List<String> headersItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[[\"content-type\",\"application/json\"],[\"content-length\",\"1024\"]]", required = true, value = "The request headers sent in the webhook.")
