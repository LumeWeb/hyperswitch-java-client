...
import com.hyperswitch.model.PayoutCreateRequestCustomer;
import com.hyperswitch.model.PayoutCreateRequestPayoutLinkConfig;
import com.hyperswitch.model.PayoutCreateRequestPayoutMethodData;
import com.hyperswitch.model.PayoutCreateRequestRouting;
...
public class PayoutCreateRequest {
  ...
  private JsonNullable<PayoutCreateRequestRouting> routing = JsonNullable.<PayoutCreateRequestRouting>undefined();
  ...
  private JsonNullable<PayoutCreateRequestPayoutMethodData> payoutMethodData = JsonNullable.<PayoutCreateRequestPayoutMethodData>undefined();
  ...
  private JsonNullable<PayoutCreateRequestCustomer> customer = JsonNullable.<PayoutCreateRequestCustomer>undefined();
  ...
  private JsonNullable<PayoutCreateRequestPayoutLinkConfig> payoutLinkConfig = JsonNullable.<PayoutCreateRequestPayoutLinkConfig>undefined();
  ...
  **/
  ...
  @ApiModelProperty(example = "187282ab-40ef-47a9-9206-5099ba31e432", value = "Unique identifier for the payout. This ensures idempotency for multiple payouts that have been done by a single merchant. This field is auto generated and is returned in the API response, **not required to be included in the Payout Create/Update Request.**")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "merchant_1668273825", value = "This is an identifier for the merchant account. This is inferred from the API key provided during the request, **not required to be included in the Payout Create/Update Request.**")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000", value = "The payout amount. Amount for the payout in lowest denomination of the currency. (i.e) in cents for USD denomination, in paisa for INR denomination etc.,")
  @JsonIgnore
  ...
  **/
  ...
  public PayoutCreateRequest routing(PayoutCreateRequestRouting routing) {
    this.routing = JsonNullable.<PayoutCreateRequestRouting>of(routing);
  ...
  **/
  ...
  public PayoutCreateRequestRouting getRouting() {
  ...
  public JsonNullable<PayoutCreateRequestRouting> getRouting_JsonNullable() {
    return routing;
  }
  
  @JsonProperty(JSON_PROPERTY_ROUTING)
  public void setRouting_JsonNullable(JsonNullable<PayoutCreateRequestRouting> routing) {
    this.routing = routing;
  }

  public void setRouting(PayoutCreateRequestRouting routing) {
    this.routing = JsonNullable.<PayoutCreateRequestRouting>of(routing);
  }


  public PayoutCreateRequest connector(List<PayoutConnectors> connector) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"wise\",\"adyen\"]", value = "This field allows the merchant to manually select a connector with which the payout can go through.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "This field is used when merchant wants to confirm the payout, thus useful for the payout _Confirm_ request. Ideally merchants should _Create_ a payout, _Update_ it (if required), then _Confirm_ it.")
  @JsonIgnore
  ...
  **/
  ...
  public PayoutCreateRequest payoutMethodData(PayoutCreateRequestPayoutMethodData payoutMethodData) {
    this.payoutMethodData = JsonNullable.<PayoutCreateRequestPayoutMethodData>of(payoutMethodData);
  ...
  **/
  ...
  public PayoutCreateRequestPayoutMethodData getPayoutMethodData() {
  ...
  public JsonNullable<PayoutCreateRequestPayoutMethodData> getPayoutMethodData_JsonNullable() {
    return payoutMethodData;
  }
  
  @JsonProperty(JSON_PROPERTY_PAYOUT_METHOD_DATA)
  public void setPayoutMethodData_JsonNullable(JsonNullable<PayoutCreateRequestPayoutMethodData> payoutMethodData) {
    this.payoutMethodData = payoutMethodData;
  }

  public void setPayoutMethodData(PayoutCreateRequestPayoutMethodData payoutMethodData) {
    this.payoutMethodData = JsonNullable.<PayoutCreateRequestPayoutMethodData>of(payoutMethodData);
  }


  public PayoutCreateRequest billing(CustomerPaymentMethodBilling billing) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Set to true to confirm the payout without review, no further action required")
  @JsonIgnore
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "cus_y3oqhf46pyzuxjbcn2giaqnb44", value = "The identifier for the customer object. If not provided the customer ID will be autogenerated. _Deprecated: Use customer_id instead._")
  @JsonIgnore
  ...
  public PayoutCreateRequest customer(PayoutCreateRequestCustomer customer) {
    this.customer = JsonNullable.<PayoutCreateRequestCustomer>of(customer);
  ...
  **/
  ...
  public PayoutCreateRequestCustomer getCustomer() {
  ...
  public JsonNullable<PayoutCreateRequestCustomer> getCustomer_JsonNullable() {
    return customer;
  }
  
  @JsonProperty(JSON_PROPERTY_CUSTOMER)
  public void setCustomer_JsonNullable(JsonNullable<PayoutCreateRequestCustomer> customer) {
    this.customer = customer;
  }

  public void setCustomer(PayoutCreateRequestCustomer customer) {
    this.customer = JsonNullable.<PayoutCreateRequestCustomer>of(customer);
  }
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "food", value = "Business label of the merchant for this payout. _Deprecated: Use profile_id instead._")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether or not the payout request is recurring")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "187282ab-40ef-47a9-9206-5099ba31e432", value = "Provide a reference to a stored payout method, used to process the payout.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The business profile to use for this payout, especially if there are multiple business profiles associated with the account, otherwise default business profile associated with the merchant account will be used.")
  @JsonIgnore
  ...
  public PayoutCreateRequest priority(PayoutSendPriority priority) {
  ...
  **/
  ...
  public PayoutCreateRequest payoutLink(Boolean payoutLink) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether to get the payout link (if applicable). Merchant need to specify this during the Payout _Create_, this field can not be updated during Payout _Update_.")
  @JsonIgnore
  ...
  public PayoutCreateRequest payoutLinkConfig(PayoutCreateRequestPayoutLinkConfig payoutLinkConfig) {
    this.payoutLinkConfig = JsonNullable.<PayoutCreateRequestPayoutLinkConfig>of(payoutLinkConfig);
  ...
  **/
  ...
  public PayoutCreateRequestPayoutLinkConfig getPayoutLinkConfig() {
  ...
  public JsonNullable<PayoutCreateRequestPayoutLinkConfig> getPayoutLinkConfig_JsonNullable() {
    return payoutLinkConfig;
  }
  
  @JsonProperty(JSON_PROPERTY_PAYOUT_LINK_CONFIG)
  public void setPayoutLinkConfig_JsonNullable(JsonNullable<PayoutCreateRequestPayoutLinkConfig> payoutLinkConfig) {
    this.payoutLinkConfig = payoutLinkConfig;
  }

  public void setPayoutLinkConfig(PayoutCreateRequestPayoutLinkConfig payoutLinkConfig) {
    this.payoutLinkConfig = JsonNullable.<PayoutCreateRequestPayoutLinkConfig>of(payoutLinkConfig);
  }


  public PayoutCreateRequest sessionExpiry(Integer sessionExpiry) {
