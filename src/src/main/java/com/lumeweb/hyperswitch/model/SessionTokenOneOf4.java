...
public class SessionTokenOneOf4 {
  ...
  /**
   * Return true if this SessionToken_oneOf_4 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConnectorSdkPublicKey() != null) {
      joiner.add(String.format("%sconnector_sdk_public_key%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConnectorSdkPublicKey()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `connector_merchant_id` to the URL query string
    if (getConnectorMerchantId() != null) {
      joiner.add(String.format("%sconnector_merchant_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getConnectorMerchantId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
