...
public class PaypalSessionTokenResponse {
  ...
  public PaypalSessionTokenResponse connector(String connector) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the connector")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The session token for PayPal")
  ...
  public PaypalSessionTokenResponse sdkNextAction(SdkNextAction sdkNextAction) {
