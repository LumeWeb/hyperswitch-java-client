...
public class WalletDataOneOf23 {
  ...
  /**
   * Return true if this WalletData_oneOf_23 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WalletDataOneOf23 walletDataOneOf23 = (WalletDataOneOf23) o;
    return Objects.equals(this.weChatPayRedirect, walletDataOneOf23.weChatPayRedirect);
  }

  @Override
  public int hashCode() {
    return Objects.hash(weChatPayRedirect);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WalletDataOneOf23 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWeChatPayRedirect() != null) {
      joiner.add(String.format("%swe_chat_pay_redirect%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getWeChatPayRedirect()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
