...
import com.lumeweb.hyperswitch.model.BankHolderType;
import com.lumeweb.hyperswitch.model.BankNames;
import com.lumeweb.hyperswitch.model.BankType;
...
public class AchBankDebitAdditionalData {
  ...
  /**
   * Return true if this AchBankDebitAdditionalData object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRoutingNumber() != null) {
      joiner.add(String.format("%srouting_number%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRoutingNumber()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getBankType() != null) {
      joiner.add(String.format("%sbank_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBankType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `bank_holder_type` to the URL query string
    if (getBankHolderType() != null) {
      joiner.add(String.format("%sbank_holder_type%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBankHolderType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
