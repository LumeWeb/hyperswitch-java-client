...
public class NextActionDataOneOf3 {
  ...
  /**
   * Return true if this NextActionData_oneOf_3 object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getImageDataUrl() != null) {
      joiner.add(String.format("%simage_data_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getImageDataUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `display_to_timestamp` to the URL query string
    if (getDisplayToTimestamp() != null) {
      joiner.add(String.format("%sdisplay_to_timestamp%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisplayToTimestamp()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `qr_code_url` to the URL query string
    if (getQrCodeUrl() != null) {
      joiner.add(String.format("%sqr_code_url%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getQrCodeUrl()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
