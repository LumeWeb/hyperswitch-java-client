...
public class RetrievePaymentLinkRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "It's a token used for client side verification.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    RetrievePaymentLinkRequest retrievePaymentLinkRequest = (RetrievePaymentLinkRequest) o;
    return equalsNullable(this.clientSecret, retrievePaymentLinkRequest.clientSecret);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(clientSecret));
  }
  ...
  public String toString() {
    ...
    sb.append("class RetrievePaymentLinkRequest {\n");
