...
public class RoutingAlgorithm {
  ...
  public RoutingAlgorithm type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public RoutingAlgorithm data(@javax.annotation.Nonnull ProgramConnectorSelection data) {
