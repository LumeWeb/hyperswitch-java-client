...
public class GpayTokenParameters {
  ...
  public GpayTokenParameters stripeColonVersion(@javax.annotation.Nullable String stripeColonVersion) {
  ...
  public void setStripeColonVersion(@javax.annotation.Nullable String stripeColonVersion) {
    this.stripeColonVersion = JsonNullable.<String>of(stripeColonVersion);
  }


  public GpayTokenParameters stripeColonPublishableKey(@javax.annotation.Nullable String stripeColonPublishableKey) {
  ...
  public void setStripeColonPublishableKey(@javax.annotation.Nullable String stripeColonPublishableKey) {
    this.stripeColonPublishableKey = JsonNullable.<String>of(stripeColonPublishableKey);
  }


  /**
   * Return true if this GpayTokenParameters object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGatewayMerchantId() != null) {
      joiner.add(String.format("%sgateway_merchant_id%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getGatewayMerchantId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `stripe:version` to the URL query string
    if (getStripeColonVersion() != null) {
      joiner.add(String.format("%sstripe:version%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getStripeColonVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `stripe:publishableKey` to the URL query string
    if (getStripeColonPublishableKey() != null) {
      joiner.add(String.format("%sstripe:publishableKey%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getStripeColonPublishableKey()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
