...
import com.lumeweb.hyperswitch.model.CustomerPaymentMethod;
...
public class CustomerPaymentMethodsListResponse {
  ...
  /**
   * Return true if this CustomerPaymentMethodsListResponse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsGuestCustomer() != null) {
      joiner.add(String.format("%sis_guest_customer%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsGuestCustomer()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
