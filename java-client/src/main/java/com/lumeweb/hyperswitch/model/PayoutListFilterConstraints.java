...
public class PayoutListFilterConstraints {
  ...
  public PayoutListFilterConstraints startTime(@javax.annotation.Nonnull OffsetDateTime startTime) {
  ...
  public PayoutListFilterConstraints endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public PayoutListFilterConstraints payoutId(@javax.annotation.Nullable String payoutId) {
  ...
  public PayoutListFilterConstraints profileId(@javax.annotation.Nullable String profileId) {
  ...
  public PayoutListFilterConstraints customerId(@javax.annotation.Nullable String customerId) {
  ...
  public PayoutListFilterConstraints limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PayoutListFilterConstraints offset(@javax.annotation.Nullable Integer offset) {
  ...
  public PayoutListFilterConstraints connector(@javax.annotation.Nullable List<PayoutConnectors> connector) {
  ...
  public PayoutListFilterConstraints currency(@javax.annotation.Nonnull Currency currency) {
  ...
  public PayoutListFilterConstraints status(@javax.annotation.Nullable List<PayoutStatus> status) {
  ...
  public void setStatus(@javax.annotation.Nullable List<PayoutStatus> status) {
    this.status = JsonNullable.<List<PayoutStatus>>of(status);
  }


  public PayoutListFilterConstraints payoutMethod(@javax.annotation.Nullable List<PayoutType> payoutMethod) {
  ...
  public void setPayoutMethod(@javax.annotation.Nullable List<PayoutType> payoutMethod) {
    this.payoutMethod = JsonNullable.<List<PayoutType>>of(payoutMethod);
  }


  public PayoutListFilterConstraints entityType(@javax.annotation.Nonnull PayoutEntityType entityType) {
  ...
  /**
   * Return true if this PayoutListFilterConstraints object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startTime, payoutListFilterConstraints.startTime) &&
        equalsNullable(this.endTime, payoutListFilterConstraints.endTime) &&
        equalsNullable(this.payoutId, payoutListFilterConstraints.payoutId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startTime, hashCodeNullable(endTime), hashCodeNullable(payoutId), hashCodeNullable(profileId), hashCodeNullable(customerId), limit, hashCodeNullable(offset), hashCodeNullable(connector), currency, hashCodeNullable(status), hashCodeNullable(payoutMethod), entityType);
  }
      ...
      for (int i = 0; i < getPayoutMethod().size(); i++) {
        if (getPayoutMethod().get(i) != null) {
          joiner.add(String.format("%spayout_method%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
              URLEncoder.encode(ApiClient.valueToString(getPayoutMethod().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
      }
    }
