...
import com.hyperswitch.model.PaymentsConfirmIntentResponseError;
 ...
 */
@ApiModel(description = "Response for Payment Intent Confirm")
@JsonPropertyOrder({
...
public class PaymentsConfirmIntentResponse {
  ...
  private JsonNullable<PaymentsConfirmIntentResponseError> error = JsonNullable.<PaymentsConfirmIntentResponseError>undefined();
  ...
  **/
  ...
  @ApiModelProperty(example = "12345_pay_01926c58bc6e77c09e809964e72af8c8", required = true, value = "Unique identifier for the payment. This ensures idempotency for multiple payments that have been done by a single merchant.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "stripe", required = true, value = "The connector used for the payment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "It's a token used for client side verification.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-10T10:11:12Z", required = true, value = "Time when the payment was created")
  ...
  public PaymentsConfirmIntentResponse paymentMethodData(PaymentsConfirmIntentResponsePaymentMethodData paymentMethodData) {
  ...
  **/
  ...
  public PaymentsConfirmIntentResponse nextAction(PaymentsConfirmIntentResponseNextAction nextAction) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Identifier of the connector ( merchant connector account ) which was chosen to make the payment")
  ...
  public PaymentsConfirmIntentResponse browserInfo(PaymentsConfirmIntentRequestBrowserInfo browserInfo) {
  ...
  **/
  ...
  public PaymentsConfirmIntentResponse error(PaymentsConfirmIntentResponseError error) {
    this.error = JsonNullable.<PaymentsConfirmIntentResponseError>of(error);
  ...
  **/
  ...
  public PaymentsConfirmIntentResponseError getError() {
  ...
  public JsonNullable<PaymentsConfirmIntentResponseError> getError_JsonNullable() {
    return error;
  }
  
  @JsonProperty(JSON_PROPERTY_ERROR)
  public void setError_JsonNullable(JsonNullable<PaymentsConfirmIntentResponseError> error) {
    this.error = error;
  }

  public void setError(PaymentsConfirmIntentResponseError error) {
    this.error = JsonNullable.<PaymentsConfirmIntentResponseError>of(error);
  }
