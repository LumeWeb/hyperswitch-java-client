 ...
 */
@ApiModel(description = "Masked payout method details for bank payout method")
@JsonPropertyOrder({
...
public class BankAdditionalData {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "DE8937******013000", required = true, value = "Partially masked international bank account number (iban) for SEPA")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "HSBCGB2LXXX", value = "[8 / 11 digits] Bank Identifier Code (bic) / Swift Code - used in many countries for identifying a bank and it's branches")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "a1f4102e ****** 6fa48899c1d1", value = "Partially masked unique key for pix transfer")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "**** 124689", value = "Partially masked CPF - CPF is a Brazilian tax identification number")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "**** 417312", value = "Partially masked CNPJ - CNPJ is a Brazilian company tax identification number")
  @JsonIgnore
